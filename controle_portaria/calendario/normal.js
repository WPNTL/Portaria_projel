...
var gBegin=[2006,1,1];	// calendar date range begin from [Year,Month,Date]. Using gToday here will make it start from today.
...
//DESCRIÇÃO - DIA HOJE
var gsBottom="<A href='javascript:void(0)' class='BottomAnchor' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"You cannot select today!\");return false;' onmouseover='return true;' >Hoje : "+gToday[2]+" "+gMonths[gToday[1]-1]+", "+gToday[0]+"</A>";	// the content of the bottom section.
