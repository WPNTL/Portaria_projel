...
$resultado = mysql_query($sql) or die ("Não foi possível 1");  

	echo "TEM PERMISSÃO ALTERAR TODOS DADOS.................";
		} // se não tiver valor no campo tempo_seg
...
echo "NÃO ALTERA DATA E HORA SOLICITADA (JÁ EXITEM VALORES), MAS ALTERA O RESTO."; 
...
echo "NÃO TEM PERMISSÃO ALTERAR DATA E HORA SOLICITADA, MAS ALTERA O RESTO."; 
