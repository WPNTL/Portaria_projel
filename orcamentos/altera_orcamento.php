...
$sql = "SELECT * FROM n_orcamento WHERE n_orc='$n_orc'";
$resultado = mysql_query($sql) or die ("Não foi possível realizar a consulta ao banco de dados");
while ($linha=mysql_fetch_array($resultado)) {
$n_orc = $linha["n_orc"]; 
...
<td class=left>
<input class=left name=valor_novo maxLength=10 size=10 value="<? echo $valor; ?>"
...
<td class=left>*/?>
<input class=nedita_center type=hidden readonly name=data_novo maxLength=12 size=12 value=<?echo $data_novo ?> >
<?/*</td></tr>*/?>
