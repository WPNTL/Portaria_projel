...
$totallargura_especialo = mysql_num_rows($buscalargura_especial); $count = $totallargura_especial-1;
for($i=0; $i<$totaltamanho; $i++) { $nomelargura_especial = mysql_result($buscalargura_especial,$i,"largura_especial"); $palavraslargura_especial.="'$nomelargura_especial'";
if($i<$count) { $palavraslargura_especial.=","; } }
?>
<td class=left>
<input <?echo $classlargura_especial;?> <?echo $readonly_largura_especial;?> name=largura_especial_novo maxLength=5 size=7 value="<?echo $largura_especial?>" onKeyUp="checkList(this,arvorelargura_especial);Texto_Maiuscula_Altera();" id="textbox7" onFocus="nextfield ='arranjo_novo';">
</td>
<? } else { ?>
