...
<? if ( $lib_preparacao == "ver" OR $lib_preparacao == "alt" ) { ?>
<TH align=middle widht="8%" ><P class=bordas>
<?	if ( $check_preparacao == "" ) { ?>  Dt Previsão
<? } } ?>
</P></TH>
...
/*		SETOR PREPARAÇÃO		*/
$dt_prog_preparacao = $dados["dt_prog_preparacao"]; 
...
else {$dt_prog_preparacao = ($dia_dt_prog_preparacao."/".$mes_dt_prog_preparacao."/".$ano_dt_prog_preparacao); }
/*		SETOR PREPARAÇAO		*/
...
<?
$data_hoje_mktime  = mktime(0,0,0,$mes,$dia,$ano);
$dt_prog_preparacao_mktime = mktime(0,0,0,$mes_dt_prog_preparacao,$dia_dt_prog_preparacao,$ano_dt_prog_preparacao);

if  ($baixa == "P") {
	if ( $data_hoje_mktime > $dt_prog_preparacao_mktime ) {  ?>
<FONT COLOR="#FF0000">
<? } else { ?>
<FONT COLOR="#006400">
<? }  

	if ( $data_hoje == $dt_prog_preparacao OR $proxima_data11 == $dt_prog_preparacao OR $proxima_data12 == $dt_prog_preparacao OR $proxima_data13 == $dt_prog_preparacao OR $proxima_data14 == $dt_prog_preparacao OR $proxima_data15 == $dt_prog_preparacao OR $proxima_data16 == $dt_prog_preparacao OR $proxima_data17 == $dt_prog_preparacao ) { ?>
<FONT COLOR="#FF9900">
<? } } ?>

<? if ($status_preparacao == "E") { ?>
<FONT COLOR="#000000">
<? } ?>

<? if ($status_preparacao == "N") { ?>
<FONT COLOR="#000000">
<? } ?>
...
<?   /* CORTE DT PROG */  ?>
<? if ( $lib_preparacao_setor == "ver" OR $lib_preparacao_setor == "alt" ) { ?>
<TD align=middle><P class=bordas> 
<?	if ( $check_preparacao == "" ) { ?>
<span style="width:70px;word-wrap:break-word;"> 
...
echo number_format($media_concluidos_proj, 2, '.', ''); ?>
	...
	<TD align=middle><P class=bordas> </P></TD>
	<TD align=middle><P class=bordas> </P></TD>
	<TD align=middle><P class=bordas> <?echo number_format($data_total_dias_media,1,',','');/*echo ceil("$data_total_dias_media");*/?> </P></TD>
	<TD align=middle><P class=bordas> <?echo number_format($resultado_dias_proj_media,1,',','');/*echo ceil("$resultado_dias_proj_media");*/?> </P></TD>
	<TD align=middle><P class=bordas> <?echo number_format($porcentagem_total_media,1,',','');/*echo ceil("$porcentagem_total_media");*/?> </P></TD>
	<?	if ( $check_proj == "" ) { ?>
	<? } } ?>
...
<?echo number_format($pontualidade_qual,2,',',''); ?>  </P></TD>
	...
	<? } } ?>
		...
		<? if ( $lib_preparacao_setor == "ver" OR $lib_prepraracao_setor == "alt" ) { ?>
	<TD align=middle><P class=bordas> </P></TD>
	<TD align=middle><P class=bordas> </P></TD>
	<?	if ( $check_preparacao == "" ) { ?>
	<? } } ?>
