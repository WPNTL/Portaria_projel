...
$sql    =   mysql_query("SELECT * FROM pcp WHERE id>='0' $f_data_emissao_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_representante_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_construcao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_db $f_data_prog_diaria_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db ORDER BY data_entrega", $conn);
...
//MONTA O CABEÇALHO              
   ...
   $pdf->Cell(200, -15, "Impressão PCP Geral" , 0, 0, 'C');    
