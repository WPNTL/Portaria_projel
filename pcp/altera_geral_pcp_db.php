...
/*		STATUS	e DT STATUS	*/
 ...
 $pintura_novo_db = $pintura_novo[$i] ;  // ALTERACAO PINTURA
 
  $preparacao_novo_db = $preparacao_novo[$i] ;  // ALTERACAO PREPARACAO
 
 $construcao_novo_db = $construcao_novo[$i] ;  // ALTERACAO CONSTRUCAO
 ...
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), proj_os_status='$proj_os_status_novo_db', data_book='$data_book_novo_db', certif_balanc='$certif_balanc_novo_db', certif_materiais='$certif_materiais_novo_db', desenho_certif='$desenho_certif_novo_db', pintura='$pintura_novo_db', construcao='$construcao_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar proj_os_status_novo!!!"); 
 
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), proj_os_dt_entrada='$proj_os_dt_entrada_novo_db', data_book='$data_book_novo_db', certif_balanc='$certif_balanc_novo_db', certif_materiais='$certif_materiais_novo_db', pintura='$pintura_novo_db', construcao='$construcao_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar proj_os_status_novo!!!"); 
...
if ($lib_tag == "alt") {
 ...
 $tag_novo_db = $tag_novo[$i] ;  // data book novo

 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), tag='$tag_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar TAG!!!"); 
}
}
/*----------- TAG -----------*/
...
if ($lib_int_lub == "alt") {
 ...
 $int_lub_novo_db = $int_lub_novo[$i] ;  // data book novo

 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), int_lub='$int_lub_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar INT LUB!!!"); 
}
}
/*----------- INT LUBR -----------*/
...
if ($lib_mat1 == "alt") {
 ...
 $mat1_novo_db = $mat1_novo[$i] ;  // data book novo

 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), mat1='$mat1_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar Mat 1!!!"); 
}
}
/*----------- MAT 1 -----------*/
...
if ($lib_mat2 == "alt") {
 ...
 $mat2_novo_db = $mat2_novo[$i] ;  // data book novo

 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), mat2='$mat2_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar Mat 2!!!"); 
}
}
/*----------- MAT 2 -----------*/
...
if ($lib_mat3 == "alt") {
 ...
 $mat3_novo_db = $mat3_novo[$i] ;  // data book novo

 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), mat3='$mat3_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar Mat 3!!!"); 
}
}
/*----------- MAT 3 -----------*/
...
if ($lib_outros == "alt") {
 ...
 $outros_novo_db = $outros_novo[$i] ;  // data book novo

 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), outros='$outros_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar Mat 3!!!"); 
}
}
/*----------- OUTROS -----------*/
/*-------------------------------- MATERIAIS -------------------------------*/
...
/*		STATUS	e DT STATUS	*/
 ...
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), status_almox='$status_almox_novo_db', res_almox='$res_almox_novo_db', obs_almox='$obs_almox_novo_db', dt_previsao_almox='$dt_previsao_almox_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar status_almox_novo OS!!!");  
 
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), dt_producao_almox='$dt_producao_almox_novo_db', res_almox='$res_almox_novo_db', obs_almox='$obs_almox_novo_db', dt_previsao_almox='$dt_previsao_almox_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar dt_producao_almox_novo!!!"); 
  
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), dt_exp_almox='$dt_exp_almox_novo_db', res_almox='$res_almox_novo_db', obs_almox='$obs_almox_novo_db', dt_previsao_almox='$dt_previsao_almox_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar dt_exp_almox_novo!!!");
...
/*		STATUS	e DT STATUS	*/
 ...
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), status_corte='$status_corte_novo_db', res_corte='$res_corte_novo_db', obs_corte='$obs_corte_novo_db', dt_previsao_corte='$dt_previsao_corte_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar status_corte_novo OS!!!");  
 
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), dt_producao_corte='$dt_producao_corte_novo_db', res_corte='$res_corte_novo_db', obs_corte='$obs_corte_novo_db', dt_previsao_corte='$dt_previsao_corte_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar dt_producao_corte_novo!!!"); 
  
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), dt_exp_corte='$dt_exp_corte_novo_db', res_corte='$res_corte_novo_db', obs_corte='$obs_corte_novo_db', dt_previsao_corte='$dt_previsao_corte_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar dt_exp_novo!!!");
...
/*		STATUS	e DT STATUS	*/
 ...
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), status_cald1='$status_cald1_novo_db', res_cald1='$res_cald1_novo_db', obs_cald1='$obs_cald1_novo_db', dt_previsao_cald1='$dt_previsao_cald1_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar status_cald1_novo OS!!!");  
 
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), dt_producao_cald1='$dt_producao_cald1_novo_db', res_cald1='$res_cald1_novo_db', obs_cald1='$obs_cald1_novo_db',  dt_previsao_cald1='$dt_previsao_cald1_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar dt_producao_cald1_novo!!!"); 
  
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), dt_exp_cald1='$dt_exp_cald1_novo_db', res_cald1='$res_cald1_novo_db', obs_cald1='$obs_cald1_novo_db', dt_previsao_cald1='$dt_previsao_cald1_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar dt_exp_cald1_novo!!!");
...
/*		STATUS	e DT STATUS	*/
 ...
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), status_cald2='$status_cald2_novo_db', res_cald2='$res_cald2_novo_db', obs_cald2='$obs_cald2_novo_db', dt_previsao_cald2='$dt_previsao_cald2_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar status_cald1_novo OS!!!");  
 
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), dt_producao_cald2='$dt_producao_cald2_novo_db', res_cald2='$res_cald2_novo_db', obs_cald2='$obs_cald2_novo_db', dt_previsao_cald2='$dt_previsao_cald2_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar dt_producao_cald1_novo!!!"); 
  
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), dt_exp_cald2='$dt_exp_cald2_novo_db', res_cald2='$res_cald2_novo_db', obs_cald2='$obs_cald2_novo_db', dt_previsao_cald2='$dt_previsao_cald2_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar dt_exp_cald1_novo!!!");
...
/*		STATUS	e DT STATUS	*/
 ...
 $id_novo = $id[$i] ;	
 $dt_producao_preparacao_velho[$i] ; // DT. STATUS ENTRADA ANTIGO
 $dt_exp_preparacao_velho[$i] ; // DT. STATUS SAIDA ANTIGO
 
 $status_preparacao_velho[$i] ;  // STATUS ANTIGO
 $status_preparacao_novo_db = $status_preparacao_novo[$i] ;  // STATUS NOVO
 
 $dt_previsao_preparacao_novo_db = $dt_previsao_preparacao_novo[$i] ; // DT PREVISAO
 
 $res_preparacao_novo_db = $res_preparacao_novo[$i] ;  // RESPONSAVEL NOVO
 $obs_preparacao_novo_db = $obs_preparacao_novo[$i] ;  // OBS NOVO
 
 if ( $status_preparacao_novo[$i] == "P" AND $status_preparacao_velho[$i] <> $status_preparacao_novo[$i] ) 
 	{ // SE FOI ALTERADO O STATUS, A DT. STASTUS ENTRADA  SERÁ IGUAL DT. HOJE 	
	$dt_producao_preparacao_novo_db = ($ano_emissao."/".$mes_emissao."/".$dia_emissao); 
	} 
 else 
	{ // SE NÃO FOI ALTERADO O STATUS, A DT. STASTUS SERÁ IGUAL DT. STATUS ANTIGO
	$dt_producao_preparacao_novo_db = $dt_producao_preparacao_velho[$i]; 
	$dia_dt_producao_preparacao_novo_db = substr($dt_producao_preparacao_novo_db, -10,2); 
    $mes_dt_producao_preparacao_novo_db = substr($dt_producao_preparacao_novo_db, -7,2);
    $ano_dt_producao_preparacao_novo_db = substr($dt_producao_preparacao_novo_db, -4);
 	if ($dia_dt_producao_preparacao_novo_db == "" AND $mes_dt_producao_preparacao_novo_db == "" AND $ano_dt_producao_preparacao_novo_db == "") 
	{$dt_producao_preparacao_novo_db = ($ano_dt_producao_preparacao_novo_db."".$mes_dt_producao_preparacao_novo_db."".$dia_dt_producao_preparacao_novo_db); } 
else 
	{$dt_producao_preparacao_novo_db = ($ano_dt_producao_preparacao_novo_db."/".$mes_dt_producao_preparacao_novo_db."/".$dia_dt_producao_preparacao_novo_db); }
	}
	
 if ( $status_preparacao_novo[$i] == "E" AND $status_preparacao_velho[$i] <> $status_preparacao_novo[$i] ) 
 	{ // SE FOI ALTERADO O STATUS, A DT. STASTUS SAIDA SERÁ IGUAL DT. HOJE 	
	$dt_exp_preparacao_novo_db = ($ano_emissao."/".$mes_emissao."/".$dia_emissao); 
	} 
 else 
	{ // SE NÃO FOI ALTERADO O STATUS, A DT. STASTUS SERÁ IGUAL DT. STATUS ANTIGO
	$dt_exp_preparacao_novo_db = $dt_exp_preparacao_velho[$i]; 
	$dia_dt_exp_preparacao_novo_db = substr($dt_exp_preparacao_novo_db, -10,2); 
    $mes_dt_exp_preparacao_novo_db = substr($dt_exp_preparacao_novo_db, -7,2);
    $ano_dt_exp_preparacao_novo_db = substr($dt_exp_preparacao_novo_db, -4);
 	if ($dia_dt_exp_preparacao_novo_db == "" AND $mes_dt_exp_preparacao_novo_db == "" AND $ano_dt_exp_preparacao_novo_db == "") 
	{$dt_exp_preparacao_novo_db = ($ano_dt_exp_preparacao_novo_db."".$mes_dt_exp_preparacao_novo_db."".$dia_dt_exp_preparacao_novo_db); } 
else 
	{$dt_exp_preparacao_novo_db = ($ano_dt_exp_preparacao_novo_db."/".$mes_dt_exp_preparacao_novo_db."/".$dia_dt_exp_preparacao_novo_db); }
	}
 	 
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), status_preparacao='$status_preparacao_novo_db', res_preparacao='$res_preparacao_novo_db', obs_preparacao='$obs_preparacao_novo_db', dt_previsao_preparacao='$dt_previsao_preparacao_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar status_pintura_novo OS!!!");  
 
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), dt_producao_preparacao='$dt_producao_preparacao_novo_db', res_preparacao='$res_preparacao_novo_db', obs_preparacao='$obs_preparacao_novo_db', dt_previsao_preparacao='$dt_previsao_preparacao_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar dt_producao_preparacao_novo!!!"); 
  
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), dt_exp_preparacao='$dt_exp_preparacao_novo_db', res_preparacao='$res_preparacao_novo_db', obs_preparacao='$obs_preparacao_novo_db', dt_previsao_preparacao='$dt_previsao_preparacao_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar dt_exp_preparacao_novo!!!");
...
/*		STATUS	e DT STATUS	*/
 ...
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), status_rotor_ll='$status_rotor_ll_novo_db', res_rotor_ll='$res_rotor_ll_novo_db', obs_rotor_ll='$obs_rotor_ll_novo_db', dt_previsao_rotor_ll='$dt_previsao_rotor_ll_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar status_cald1_novo OS!!!");  
 
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), dt_producao_rotor_ll='$dt_producao_rotor_ll_novo_db', res_rotor_ll='$res_rotor_ll_novo_db', obs_rotor_ll='$obs_rotor_ll_novo_db', dt_previsao_rotor_ll='$dt_previsao_rotor_ll_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar dt_producao_cald1_novo!!!"); 
  
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), dt_exp_rotor_ll='$dt_exp_rotor_ll_novo_db', res_rotor_ll='$res_rotor_ll_novo_db', obs_rotor_ll='$obs_rotor_ll_novo_db', dt_previsao_rotor_ll='$dt_previsao_rotor_ll_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar dt_exp_cald1_novo!!!");
...
/*		STATUS	e DT STATUS	*/
 ...
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), status_rotor_sir='$status_rotor_sir_novo_db', res_rotor_sir='$res_rotor_sir_novo_db', obs_rotor_sir='$obs_rotor_sir_novo_db', dt_previsao_rotor_sir='$dt_previsao_rotor_sir_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar status_cald1_novo OS!!!");  
 
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), dt_producao_rotor_sir='$dt_producao_rotor_sir_novo_db', res_rotor_sir='$res_rotor_sir_novo_db', obs_rotor_sir='$obs_rotor_sir_novo_db', dt_previsao_rotor_sir='$dt_previsao_rotor_sir_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar dt_producao_cald1_novo!!!"); 
  
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), dt_exp_rotor_sir='$dt_exp_rotor_sir_novo_db', res_rotor_sir='$res_rotor_sir_novo_db', obs_rotor_sir='$obs_rotor_sir_novo_db', dt_previsao_rotor_sir='$dt_previsao_rotor_sir_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar dt_exp_cald1_novo!!!");
...
/*		STATUS	e DT STATUS	*/
 ...
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), status_montagem='$status_montagem_novo_db', res_montagem='$res_montagem_novo_db', obs_montagem='$obs_montagem_novo_db', dt_previsao_montagem='$dt_previsao_montagem_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar status_montagem_novo OS!!!");  
 
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), dt_producao_montagem='$dt_producao_montagem_novo_db', res_montagem='$res_montagem_novo_db', obs_montagem='$obs_montagem_novo_db', dt_previsao_montagem='$dt_previsao_montagem_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar dt_producao_montagem_novo!!!"); 
  
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), dt_exp_montagem='$dt_exp_montagem_novo_db', res_montagem='$res_montagem_novo_db', obs_montagem='$obs_montagem_novo_db', dt_previsao_montagem='$dt_previsao_montagem_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar dt_exp_montagem_novo!!!");
...
/*		STATUS	e DT STATUS	*/
 ...
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), status_laser='$status_laser_novo_db', res_laser='$res_laser_novo_db', obs_laser='$obs_laser_novo_db', dt_previsao_laser='$dt_previsao_laser_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar status_laser_novo OS!!!");  
 
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), dt_producao_laser='$dt_producao_laser_novo_db', res_laser='$res_laser_novo_db', obs_laser='$obs_laser_novo_db', dt_previsao_laser='$dt_previsao_laser_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar dt_producao_laser_novo!!!"); 
  
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), dt_exp_laser='$dt_exp_laser_novo_db', res_laser='$res_laser_novo_db', obs_laser='$obs_laser_novo_db', dt_previsao_laser='$dt_previsao_laser_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar dt_exp_novo!!!");
...
<option value='data_emissao' <? echo ($tipo_busca=='data_emissao'?"SELECTED":""); ?> > Data Emissão </option>
