...
<?
$buscaoc_obra = mysql_query("select distinct oc_obra from pcp where data_emissao >='".$data_1ano."' order by 'oc_obra'");
...
<?
$buscaestado = mysql_query("select distinct estado from pcp where data_emissao >='".$data_1ano."' order by 'estado'");
...
<?
$buscadescr_vent = mysql_query("select distinct descr_vent from pcp where data_emissao >='".$data_1ano."' order by 'descr_vent'");
...
<?
$buscamodelo = mysql_query("select distinct modelo from pcp where data_emissao >='".$data_1ano."' order by 'modelo'");
...
<?
$buscatamanho = mysql_query("select distinct tamanho from pcp where data_emissao >='".$data_1ano."' order by 'tamanho'");
...
<?
$buscaarranjo = mysql_query("select distinct arranjo from pcp where data_emissao >='".$data_1ano."' order by 'arranjo'");
...
<?
$buscapos_motor = mysql_query("select distinct pos_motor from pcp where data_emissao >='".$data_1ano."' order by 'pos_motor'");
...
<?
$buscatag = mysql_query("select distinct tag from pcp where data_emissao >='".$data_1ano."' order by 'tag'");
...
<?
$buscapintura = mysql_query("select distinct pintura from pcp where data_emissao >='".$data_1ano."' order by 'pintura'");
...
<?
$buscacarc_mot = mysql_query("select distinct carc_mot from pcp where data_emissao >='".$data_1ano."' order by 'carc_mot'");
...
<?
$buscaobs = mysql_query("select distinct obs from pcp where data_emissao >='".$data_1ano."' order by 'obs'");
...
<?
/* pot. motor cv */
$buscapot_motor_cv = mysql_query("select distinct pot_motor_cv from pcp where data_emissao >='".$data_1ano."' order by 'pot_motor_cv'");
...
/* pot. motor polos */
$buscapot_motor_polos = mysql_query("select distinct pot_motor_polos from pcp where data_emissao >='".$data_1ano."' order by 'pot_motor_polos'");
...
<?
$buscatensao_motor = mysql_query("select distinct tensao_motor from pcp where data_emissao >='".$data_1ano."' order by 'tensao_motor'");
...
<?
$buscavazao = mysql_query("select distinct vazao from pcp where data_emissao >='".$data_1ano."' order by 'vazao'");
...
<?
$buscarotacao_rpm = mysql_query("select distinct rotacao_rpm from pcp where data_emissao >='".$data_1ano."' order by 'rotacao_rpm'");
...
<?
$buscap_estatica_op = mysql_query("select distinct p_estatica_op from pcp where data_emissao >='".$data_1ano."' order by 'p_estatica_op'");
...
<?
$buscaint_lub = mysql_query("select distinct int_lub from pcp where data_emissao >='".$data_1ano."' order by 'int_lub'");
