...
$show_alert_new_messages = getPref($data_dir, $username, 'show_alert_new_messages', SMPREF_OFF); 
...
$internal_date_sort = getPref($data_dir, $username, 'internal_date_sort', SMPREF_OFF);
