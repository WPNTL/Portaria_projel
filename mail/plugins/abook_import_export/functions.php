            ...
            if (isset($_GET['import'])) {
                ...
                echo html_tag('tr',
                        ...
                        html_tag('td', addHidden('MAX_FILE_SIZE', $aie_csv_maxsize) .
                                '<input name="smusercsv" type="file" /></br>', 'left'));
				...
				echo html_tag('tr',
                        html_tag('td',sprintf(_("File size limit %s bytes or %s"),$aie_csv_maxsize,aie_display_size($aie_csv_maxsize),'1000') 
			. '</br></br><span style="color:red">' .  _("Is necessary nickname, first name and email to import") . '</span>'
			, 'center', '', 'colspan="2"'));									
                echo "</table>\n";
                echo "</form>\n";
