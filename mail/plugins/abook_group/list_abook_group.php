...
?>
	    <li style="clear:both;height:14px;display:block;" class='nameGroup' onmousemove="changeBackGroup(this)" onclick="changeGroup('<?php echo $groupName;?>',this,false)" onmouseout='$(this).removeClass("backGroup")'>
        <span style="display:block;float:left;height:14px;width:80px;overflow:hidden" title="<?php echo $groupName?>" onselectstart='return false' class="spanNameGroup"><?php echo $groupName ?></span>
