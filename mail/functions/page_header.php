...
function displayPageHeader($color, $mailbox, $xtra='', $session=false) {
    ...
    echo '<div id="optionSearch">' .			
           '<input type="radio" id="radioBODY" name="where" value="BODY"><label for="radioBODY">' . _("Body")  . '</label></br>
            ...
            <input type="radio" id="iradioCC" name="where" value="CC"><label for="radioCC">' . _("Cc")  . '</label></br>
			<input type="radio" id="radioTO" name="where" value="TO"><label for="radioTO">' . _("To")  . '</label>' .
