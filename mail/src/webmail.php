...
<html>
    ...
    <body>
	<input type="hidden" id="swap_folder"/>
		...
		<input type="hidden" id="flagSub" value="false"/>
        ...
        <div class="body">
            ...
            <div class="right">               
                <?php
                    ...
                    echo printHeader($mailbox, $srt,'', !$thread_sort_messages);
                 ?>
                <div id="listmails" class="listmailWindow">
                    <div class="listmail">
                        <div class="divTable">
                            <div class="divRow">
                                <div class="divCol">
        ...
        <ul id="myMenuTrash" class="contextMenu">
         ...
         <div id="dialogAttachDelete" title="<?php echo _("Delete files");?>" style="display:none">
			<p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>
			<?php
				echo _('There are attached files, they will be deleted, ok?');
			?>
			</p>
		</div>       
        ...
        <div class="dialogContacts" title="<?php echo _("Address");?>" >
              ...
              <div class="menuContact">
                ...
                <div><a style="position:relative;top:6px" href="javascript:loadFormImport()"><img class="figImport" src="../images/import.png"><?php echo _('Import contacts');?>&nbsp;</a>&nbsp;</div>
              ...
              <div class="contentContacts">
                 <div class="ContGroup">
                     <div class="label"><?php echo _('Group');?></div>
                     <div class="content" onselectstart='return false' ></div>
                 </div>
                 <div class="ContContact">
						<div class="label"><?php echo _('Contacts');?><input style="position: relative;left:160px" type="checkbox" class="checkAllCon"></div>
                     <div class="content" onselectstart='return false' ></div>
                     <div class="label" id="rodapeCont">
			<span class="paginationCont"></span>
		...
		<div id="dialogErrorImport" title="Info" style='display:none'>
			<div style="overflow:auto;height:200px">
			</div>
			<input style="position: relative;left:220px" type="button" value="OK" id="btnDialogErrorImport">
		</div>
		<?php
		global $username, $data_dir;
		$showAlert = getPref($data_dir, $username,'show_alert_new_messages');
		if($showAlert){?>
		...
		<!-- <script type='text/javascript' charset="utf-8" src='../js/tinymce_safari/jscripts/tiny_mce/tiny_mce.js'></script> -->
	    <?php
		if(isSafariMobile()){ ?>
			<script type='text/javascript' charset='utf-8' src='../js/tinymce_safari/jscripts/tiny_mce/tiny_mce.js'></script> 	
        <?php }else{ ?>			
			<script src="../js/tinymce4/js/tinymce/tinymce.min.js"></script>
			<!--script src="../js/tinymce4/js/tinymce/jquery.tinymce.js"></script>-->
			<!-- <script type='text/javascript' charset='utf-8' src='../js/tinymce/jscripts/tiny_mce/tiny_mce.js'></script> -->
        <?php
		 }       
		 ?>
        <script>
            ...
            var correctionIE;            
            $(function(){
				$("#btnDialogErrorImport").click(
					function(){
						$("#dialogErrorImport").dialog("close");
					}
				);
				$(".checkAllCon").click(
					function(){
						if($(this).attr('checked')){
							$('.ContContact .content input[type=checkbox]').attr("checked",true)
								.parent().addClass('backContact');
						}else{
                            $('.ContContact .content input[type=checkbox]').attr("checked",false)
								.parent().removeClass('backContact');
						}
					}
				);
                if($.browser.msie){
