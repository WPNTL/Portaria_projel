...
<? if ($libn_orc == "" and $checkn_orc == "") { ?> N� Or� <? } ?>
</td>
...
<? if ($libreferencia == "" and $checkreferencia == "") {?> Refer�ncia / Obra <? } ?>
</td>
...
<? if ($libperiodo == "" and $checkperiodo == "") {?> Per�odo <? } ?>
</td>

<? /* PERIODO ALTERADO */ ?>
<? if ($libperiodoalterado == "" and $checkperiodoalterado == "") {?>
<td class=center >   Per�odo Alterado </td> <? } ?>

<? /* USUARIO */ ?>
<? if ($libusuario == "" and $checkusuario == "") {?>
<td class=center >  Usu�rio </td> <? } ?>

<? /* USUARIO ALTERADO  */ ?>
<? if ($libusuarioalterado == "" and $checkusuarioalterado == "") {?>
<td class=center > Usu�rio Alterado </td> <? } ?>
