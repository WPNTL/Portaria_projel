...
<? if ( $lib_preparacao == "ver" OR $lib_preparacao == "alt" OR $lib_setor_ver == "sim" ) { ?>
<TH align=middle widht="8%" ><P class=bordas>
<?	if ( $check_preparacao == "" ) { ?>  Dt. Em Produção
<? } } ?>
</P></TH>
...
<? if ( $lib_preparacao == "ver" OR $lib_preparacao == "alt" OR $lib_setor_ver == "sim" ) { ?>
<TH align=middle widht="8%" ><P class=bordas>
<?	if ( $check_preparacao == "" ) { ?>  Dt. Expedição
<? } } ?>
</P></TH>
...
<? if ( $lib_preparacao == "ver" OR $lib_preparacao == "alt" OR $lib_setor_ver == "sim" ) { ?>
<TH align=middle widht="8%" ><P class=bordas>
<?	if ( $check_preparacao == "" ) { ?>  Responsável
<? } } ?>
</P></TH>
...
/*		SETOR PREPARAÇÃO		*/
$dt_prog_preparacao = $dados["dt_prog_preparação"];
