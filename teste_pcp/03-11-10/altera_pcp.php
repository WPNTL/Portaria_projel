...
/* MOTOR - POLIA - CARCAÇA - ROTOR DO MAXSIG */
if ($lib_motor_maxsig == "ver"){$class_motor_maxsig="class=nedita_left"; $readonly_motor_maxsig="readonly"; $disabled_motor_maxsig="disabled";}
if ($lib_polia_maxsig == "ver"){$class_polia_maxsig="class=nedita_left"; $readonly_polia_maxsig="readonly"; $disabled_polia_maxsig="disabled";}
/* MOTOR - POLIA - CARCAÇA - ROTOR DO MAXSIG */

if ($lib_fund_maxsig == "ver"){$class_fund_maxsig="class=nedita_left"; $readonly_fund_maxsig="readonly"; $disabled_fund_maxsig="disabled";}
if ($lib_outros_maxsig == "ver"){$class_outros_maxsig="class=nedita_left"; $readonly_outros_maxsig="readonly"; $disabled_outros_maxsig="disabled";}
...
<? if ($lib_maxsig == "alt" OR $lib_maxsig == "ver") { ?>
<table class=sem_borda width=100% align="center">
<BR>
...
<table class=sem_borda width=100% align="center">
<BR>
<? if ($lib_motor_maxsig == "alt" OR $lib_motor_maxsig == "ver") { ?>
<td class=rigth_sem_borda width=50%> Motor
<select <?echo $class_motor_maxsig;?> <?echo $readonly_motor_maxsig;?> <?echo $disabled_motor_maxsig;?> name=motor_maxsig_novo >
<option value=''  <? echo ($motor_maxsig==''?"SELECTED":""); ?> >  </option>
<option value='S' <? echo ($motor_maxsig=='S'?"SELECTED":""); ?> > S </option>
<option value='SP' <? echo ($motor_maxsig=='SP'?"SELECTED":""); ?> > SP </option>
<option value='C' <? echo ($motor_maxsig=='C'?"SELECTED":""); ?> > C </option>
<option value='E' <? echo ($motor_maxsig=='E'?"SELECTED":""); ?> > E </option>
<option value='EP' <? echo ($motor_maxsig=='EP'?"SELECTED":""); ?> > EP </option>
<option value='R' <? echo ($motor_maxsig=='R'?"SELECTED":""); ?> > R </option>
<option value='RP' <? echo ($motor_maxsig=='RP'?"SELECTED":""); ?> > RP </option>
<option value='M' <? echo ($motor_maxsig=='M'?"SELECTED":""); ?> > M </option>
<option value='MP' <? echo ($motor_maxsig=='MP'?"SELECTED":""); ?> > MP </option>
</select>

<? /* TIPO DE ALTERAÇÃ0 NO MOTOR */ ?>
Altera: 
<INPUT TYPE="radio" NAME="tipo_motor_maxsig" VALUE="item" checked <?echo $class_motor_maxsig;?> <?echo $readonly_motor_maxsig;?> <?echo $disabled_motor_maxsig;?> > Item
<INPUT TYPE="radio" NAME="tipo_motor_maxsig" VALUE="os" <?echo $class_motor_maxsig;?> <?echo $readonly_motor_maxsig;?> <?echo $disabled_motor_maxsig?> > OS

</td>
<? } else { ?>
<input type=hidden name=motor_maxsig_novo value="<?echo $motor_maxsig?>">
<? } ?>

<?/* POLIA MAXSIG */?>
<? if ($lib_polia_maxsig == "alt" OR $lib_polia_maxsig == "ver") { ?>
<td class=left_sem_borda width=40%> Polia
<select <?echo $class_polia_maxsig;?> <?echo $readonly_polia_maxsig;?> <?echo $disabled_polia_maxsig;?> name=polia_maxsig_novo >
<option value=''  <? echo ($polia_maxsig==''?"SELECTED":""); ?> >  </option>
<option value='S' <? echo ($polia_maxsig=='S'?"SELECTED":""); ?> > S </option>
<option value='SP' <? echo ($polia_maxsig=='SP'?"SELECTED":""); ?> > SP </option>
<option value='C' <? echo ($polia_maxsig=='C'?"SELECTED":""); ?> > C </option>
<option value='E' <? echo ($polia_maxsig=='E'?"SELECTED":""); ?> > E </option>
<option value='EP' <? echo ($polia_maxsig=='EP'?"SELECTED":""); ?> > EP </option>
<option value='R' <? echo ($polia_maxsig=='R'?"SELECTED":""); ?> > R </option>
<option value='RP' <? echo ($polia_maxsig=='RP'?"SELECTED":""); ?> > RP </option>
<option value='M' <? echo ($polia_maxsig=='M'?"SELECTED":""); ?> > M </option>
<option value='MP' <? echo ($polia_maxsig=='MP'?"SELECTED":""); ?> > MP </option>
</select>

<? /* TIPO DE ALTERAÇÃ0 NO POLIA */ ?>
Altera: 
<INPUT TYPE="radio" NAME="tipo_polia_maxsig" VALUE="item" checked <?echo $class_polia_maxsig;?> <?echo $readonly_polia_maxsig;?> <?echo $disabled_polia_maxsig;?> > Item
<INPUT TYPE="radio" NAME="tipo_polia_maxsig" VALUE="os" <?echo $class_polia_maxsig;?> <?echo $readonly_polia_maxsig;?> <?echo $disabled_polia_maxsig?> > OS

</td>
<? } else { ?>
<input type=hidden name=polia_maxsig_novo value="<?echo $polia_maxsig?>">
<? } ?>
</table>

<?/* FUND MAXSIG */?>
<table class=sem_borda width=100% align="center">
<? if ($lib_fund_maxsig == "alt" OR $lib_fund_maxsig == "ver") { ?>
<BR>
<td class=rigth_sem_borda width=50%> Fund.
<select <?echo $class_fund_maxsig;?> <?echo $readonly_fund_maxsig;?> <?echo $disabled_fund_maxsig;?> name=fund_maxsig_novo >
<option value=''  <? echo ($fund_maxsig==''?"SELECTED":""); ?> >  </option>
<option value='S' <? echo ($fund_maxsig=='S'?"SELECTED":""); ?> > S </option>
<option value='SP' <? echo ($fund_maxsig=='SP'?"SELECTED":""); ?> > SP </option>
<option value='C' <? echo ($fund_maxsig=='C'?"SELECTED":""); ?> > C </option>
<option value='E' <? echo ($fund_maxsig=='E'?"SELECTED":""); ?> > E </option>
<option value='EP' <? echo ($fund_maxsig=='EP'?"SELECTED":""); ?> > EP </option>
<option value='R' <? echo ($fund_maxsig=='R'?"SELECTED":""); ?> > R </option>
<option value='RP' <? echo ($fund_maxsig=='RP'?"SELECTED":""); ?> > RP </option>
<option value='M' <? echo ($fund_maxsig=='M'?"SELECTED":""); ?> > M </option>
<option value='MP' <? echo ($fund_maxsig=='MP'?"SELECTED":""); ?> > MP </option>
</select>

<? /* TIPO DE ALTERAÇÃ0 NO CARCAÇA */ ?>
Altera: 
<INPUT TYPE="radio" NAME="tipo_fund_maxsig" VALUE="item" checked <?echo $class_fund_maxsig;?> <?echo $readonly_fund_maxsig;?> <?echo $disabled_fund_maxsig;?> > Item
<INPUT TYPE="radio" NAME="tipo_fund_maxsig" VALUE="os" <?echo $class_fund_maxsig;?> <?echo $readonly_fund_maxsig;?> <?echo $disabled_fund_maxsig?> > OS

</td>
<? } else { ?>
<input type=hidden name=fund_maxsig_novo value="<?echo $fund_maxsig?>">
<? } ?>

<?/* OUTROS MAXSIG */?>
<? if ($lib_outros_maxsig == "alt" OR $lib_outros_maxsig == "ver") { ?>
<td class=left_sem_borda width=40%> Outros
<select <?echo $class_outros_maxsig;?> <?echo $readonly_outros_maxsig;?> <?echo $disabled_outros_maxsig;?> name=outros_maxsig_novo >
<option value=''  <? echo ($outros_maxsig==''?"SELECTED":""); ?> >  </option>
<option value='S' <? echo ($outros_maxsig=='S'?"SELECTED":""); ?> > S </option>
<option value='SP' <? echo ($outros_maxsig=='SP'?"SELECTED":""); ?> > SP </option>
<option value='C' <? echo ($outros_maxsig=='C'?"SELECTED":""); ?> > C </option>
<option value='E' <? echo ($outros_maxsig=='E'?"SELECTED":""); ?> > E </option>
<option value='EP' <? echo ($outros_maxsig=='EP'?"SELECTED":""); ?> > EP </option>
<option value='R' <? echo ($outros_maxsig=='R'?"SELECTED":""); ?> > R </option>
<option value='RP' <? echo ($outros_maxsig=='RP'?"SELECTED":""); ?> > RP </option>
<option value='M' <? echo ($outros_maxsig=='M'?"SELECTED":""); ?> > M </option>
<option value='MP' <? echo ($outros_maxsig=='MP'?"SELECTED":""); ?> > MP </option>
</select>

<? /* TIPO DE ALTERAÇÃ0 NO ROTOR */ ?>
Altera: 
<INPUT TYPE="radio" NAME="tipo_outros_maxsig" VALUE="item" checked <?echo $class_outros_maxsig;?> <?echo $readonly_outros_maxsig;?> <?echo $disabled_outros_maxsig;?> > Item
<INPUT TYPE="radio" NAME="tipo_outros_maxsig" VALUE="os" <?echo $class_outros_maxsig;?> <?echo $readonly_outros_maxsig;?> <?echo $disabled_outros_maxsig?> > OS

</td>
<? } else { ?>
<input type=hidden name=outros_maxsig_novo value="<?echo $outros_maxsig?>">
<? } ?>
</table>
...
<? if ( $lib_proj == "ver" OR $lib_proj == "alt" OR $lib_proj == "sim" ) { ?>
...
?>
<td class=left_sem_borda>
<input <?echo $class_pot_motor_cv;?> <?echo $readonly_pot_motor_cv;?> name=pot_motor_cv_novo maxLength=4 size=5 value="<?echo $pot_motor_cv?>"
onKeyUp="checkList(this,arvorepot_motor_cv);Texto_Maiuscula_Altera();" id="textbox14" onFocus="nextfield ='pot_motor_polos_novo';"> CV
<input <?echo $class_pot_motor_polos;?> <?echo $readonly_pot_motor_polos;?> name=pot_motor_polos_novo maxLength=4 size=5 value="<?echo $pot_motor_polos?>"
...
?>
<td class=left_sem_borda>
<input <?echo $class_p_estatica_op;?> <?echo $readonly_p_estatica_op;?> name=p_estatica_op_novo maxLength=5 size=6 value="<?echo $p_estatica_op?>"
onKeyUp="checkList(this,arvorep_estatica_op);Texto_Maiuscula_Altera();" id="textbox19" onFocus="nextfield ='int_lub_novo';">
mmCA
</td>
<? } else { ?>
