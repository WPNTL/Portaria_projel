...
<TH align=middle widht="10%" colspan="16"><P class=bordas>
...
$valor_total_os = 0; $quant_os = 0;

$query = "SELECT * FROM pcp WHERE id>='0' $f_data_emissao_mes_db $f_data_emissao_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_representante_db $f_estado_db $f_data_entrega_mes_db $f_data_entrega_db $f_data_prog_diaria_db $f_data_previsao_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_construcao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_ts_jat_g_fogo_db $f_status_jat_g_fogo_db $f_dt_status_jat_g_fogo_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_outros_maxsig_db $f_fund_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $baixa_organizar $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_almox_db $f_status_almox_db $f_dt_previsao_almox_db $f_dt_prog_corte_db $f_status_corte_db $f_dt_previsao_corte_db $f_dt_prog_balanc_db $f_status_balanc_db $f_dt_previsao_balanc_db $f_dt_prog_cald1_db $f_status_cald1_db $f_dt_previsao_cald1_db $f_dt_prog_cald2_db $f_status_cald2_db $f_dt_previsao_cald2_db $f_dt_prog_pintura_db $f_status_pintura_db $f_dt_previsao_pintura_db $f_dt_prog_rotor_ll_db $f_status_rotor_ll_db $f_dt_previsao_rotor_ll_db $f_dt_prog_rotor_sir_db $f_status_rotor_sir_db $f_dt_previsao_rotor_sir_db $f_dt_prog_montagem_db $f_status_montagem_db $f_dt_previsao_montagem_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db $f_dt_previsao_usinagem_eixo_db $f_dt_prog_usinagem_nuc_cubo_db $f_status_usinagem_nuc_cubo_db $f_dt_previsao_usinagem_nuc_cubo_db $f_dt_prog_usinagem_pol_mot_db $f_status_usinagem_pol_mot_db $f_dt_previsao_usinagem_pol_mot_db $f_dt_prog_usinagem_pol_vent_db $f_status_usinagem_pol_vent_db $f_dt_previsao_usinagem_pol_vent_db $f_dt_prog_usinagem_gaxeta_db $f_status_usinagem_gaxeta_db $f_dt_previsao_usinagem_gaxeta_db $f_dt_prog_gabinete_db $f_status_gabinete_db $f_dt_previsao_gabinete_db $f_dt_prog_expedicao_db $f_status_expedicao_db $f_dt_previsao_expedicao_db ORDER BY '$organizar'";
