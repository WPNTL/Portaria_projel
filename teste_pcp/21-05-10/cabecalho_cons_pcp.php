...
<TH align=middle  colspan="16"><P class=bordas>
<input class=botao2 type="checkbox" name="check_setor_ver" value="checked" <?echo $check_setor_ver?>  onMouseOver="drc('','Setores PCP'); return true;" onMouseOut="nd(); return true;" >
<? if ($check_setor_ver == "") { ?> PCP - Setores <? } ?>
<? } ?>
</P></TH>
...
<input class=botao4 type="radio" name="organizar" value="motor_maxsig" onClick="Atualizar_Dados_PCP();" onMouseOver="drc('','Organizar Motor'); return true;" onMouseOut="nd(); return true;"> Mot. <? } } ?></P></TH>

<? /* POLIA MAXSIG */ ?>
<? if ( $lib_polia_maxsig == "ver" Or $lib_polia_maxsig == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_polia_maxsig == "") {?> 
<input class=botao4 type="radio" name="organizar" value="polia_maxsig" onClick="Atualizar_Dados_PCP();" onMouseOver="drc('','Organizar Polia'); return true;" onMouseOut="nd(); return true;"> Pol. <? } } ?></P></TH>

<? /* FUND MAXSIG */ ?>
<? if ( $lib_fund_maxsig == "ver" Or $lib_fund_maxsig == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_fund_maxsig == "") {?> 
<input class=botao4 type="radio" name="organizar" value="fund_maxsig" onClick="Atualizar_Dados_PCP();" onMouseOver="drc('','Organizar Fund.'); return true;" onMouseOut="nd(); return true;"> Fund. <? } } ?></P></TH>
		
<? /* OUTROS MAXSIG */ ?>
<? if ( $lib_outros_maxsig == "ver" Or $lib_outros_maxsig == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_outros_maxsig == "") {?> 
<input class=botao4 type="radio" name="organizar" value="outros_maxsig" onClick="Atualizar_Dados_PCP();" onMouseOver="drc('','Organizar Outros'); return true;" onMouseOut="nd(); return true;"> Outros <? } } ?></P></TH>
...
<select <?echo $botao?> size="1" name="f_motor_maxsig"  style='width:40px'>
 <?
  $query = "select distinct motor_maxsig from pcp where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db  $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by motor_maxsig";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_outros_maxsig"  style='width:40px'>
 <?
  $query = "select distinct outros_maxsig from pcp where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db  $f_motor_maxsig_db $f_polia_maxsig_db $f_fund_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by outros_maxsig";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
