...
*                                                                           *
****************************************************************************/
function FPDF($orientation='P',$unit='mm',$format='A7')
{
	...
	if(is_string($format))
	{
		...
		elseif($format=='a6')
			$format=array(297.64,420.94);
		elseif($format=='a7')
			$format=array(307.64,220.47);
	...
	$this->SetAutoPageBreak(true,0.8*$margin);
...
function Header()
{
    ...
    $this->SetFont("Arial", "B", $fonte_texto);

    // Move to the right
    $this->Image("logo1.JPG", 0,0,108,78);
...
function Header2()
{
    ...
    // Move to the right
    $this->Image("logo2.JPG", 0,0,108,78);
