...
if ( $f_baixa == "" ) { $f_baixa_db = "and baixa='E'"; $f_baixa = "E"; $organizar = $organizar;  }
...
if ( $f_fund_maxsig <> "" ) {$f_fund_maxsig_db = "and fund_maxsig='$f_fund_maxsig'";} else {$f_fund_maxsig_db = "";}
if ( $f_outros_maxsig <> "" ) {$f_outros_maxsig_db = "and outros_maxsig='$f_outros_maxsig'";} else {$f_outros_maxsig_db = "";}
...
<TH align=middle ><P class=bordas>
<input class=botao2 type="checkbox" name="check_motor_maxsig" value="checked" <?echo $check_motor_maxsig?>  onMouseOver="drc('','Mot.'); return true;" onMouseOut="nd(); return true;" >
<? } ?>
</P></TH>
...
<TH align=middle ><P class=bordas>
<input class=botao2 type="checkbox" name="check_polia_maxsig" value="checked" <?echo $check_polia_maxsig?>  onMouseOver="drc('','Pol.'); return true;" onMouseOut="nd(); return true;" >
<? } ?>
</P></TH>
...
<TH align=middle ><P class=bordas>
<input class=botao2 type="checkbox" name="check_fund_maxsig" value="checked" <?echo $check_fund_maxsig?>  onMouseOver="drc('','Fund.'); return true;" onMouseOut="nd(); return true;" >
<? } ?>
</P></TH>
...
<TH align=middle ><P class=bordas>
<input class=botao2 type="checkbox" name="check_outros_maxsig" value="checked" <?echo $check_outros_maxsig?>  onMouseOver="drc('','Outros'); return true;" onMouseOut="nd(); return true;" >
<? } ?>
</P></TH>
...
<input class=botao4 type="radio" name="organizar" value="data_emissao" onClick="Atualizar_Dados_PCP_Antigos_Antigos();" onMouseOver="drc('','Organizar Dt. Emissão'); return true;" onMouseOut="nd(); return true;"> Dt. Emissão <? } } ?></P></TH>

<? /* NUM_OS */ ?>             
<? if ( $lib_num_os == "ver" Or $lib_num_os == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if (  $check_num_os == "" ) { ?> 
<input class=botao4 type="radio" name="organizar" value="num_os" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Núm. O.S'); return true;" onMouseOut="nd(); return true;"> N° O.S <? } } ?></P></TH>

<? /* NUM_PROPOSTA */ ?>
<? if ( $lib_num_proposta == "ver" Or $lib_num_proposta == "alt" ) { ?> 
<TH align=middle  ><P class=bordas>
<?	if ( $check_num_proposta == "") { ?> 
<input class=botao4 type="radio" name="organizar" value="num_proposta" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Núm. Proposta'); return true;" onMouseOut="nd(); return true;"> N° Proposta <? } } ?></P></TH>

<? /* NOME CLIENTE */ ?> 
<? if ( $lib_nome_cliente == "ver" Or $lib_nome_cliente == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_nome_cliente == "") { ?> 
<input class=botao4 type="radio" name="organizar" value="nome_cliente" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Nome Cliente'); return true;" onMouseOut="nd(); return true;"> Nome Cliente <? } } ?></P></TH>

<? /* OC / OBRA */ ?>
<? if ( $lib_oc_obra == "ver" Or $lib_oc_obra == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_oc_obra == "") { ?> 
<input class=botao4 type="radio" name="organizar" value="oc_obra" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Oc_Obra'); return true;" onMouseOut="nd(); return true;">OC / Obra <? } } ?></P></TH>

<? /* MERCADO */ ?>
<? if ( $lib_mercado == "ver" Or $lib_mercado == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_mercado == "") { ?> 
<input class=botao4 type="radio" name="organizar" value="mercado" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Mercado'); return true;" onMouseOut="nd(); return true;"> Merc. <? } } ?></P></TH>

<? /* REPRESENTANTE */ ?>
<? if ( $lib_representante == "ver" Or $lib_representante == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_representante == "") { ?> 
<input class=botao4 type="radio" name="organizar" value="mercado" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Representante'); return true;" onMouseOut="nd(); return true;"> Repres. <? } } ?></P></TH>
                      
<? /* ESTADO */ ?>
<? if ( $lib_estado == "ver" Or $lib_estado == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_estado == "") {?> 
<input class=botao4 type="radio" name="organizar" value="estado" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Estado'); return true;" onMouseOut="nd(); return true;"> Estado <? } } ?></P></TH>

<? /* DATA DA ENTREGA */ ?>
<? if ( $lib_data_entrega == "ver" Or $lib_data_entrega == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_data_entrega == "") {?> 
<input class=botao4 type="radio" name="organizar" value="data_entrega" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Data Entrega'); return true;" onMouseOut="nd(); return true;"> Dt. Entrega <? } } ?></P></TH>

<? /* REPROGRAMACAO */ ?>
<? if ( $lib_reprogramacao == "ver" Or $lib_reprogramacao == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_reprogramacao == "") {?> 
<input class=botao4 type="radio" name="organizar" value="reprogramacao" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Reprogramação'); return true;" onMouseOut="nd(); return true;"> Reprog. <? } } ?></P></TH>

<? /* BAIXA */ ?>
<? if ( $lib_baixa == "ver" Or $lib_baixa == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_baixa == "") {?> 
<input class=botao4 type="radio" name="organizar" value="baixa" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Baixa'); return true;" onMouseOut="nd(); return true;"> Baixa <? } } ?></P></TH>

<? /* DATA BAIXA */ ?>
<? if ( $lib_data_baixa == "ver" Or $lib_data_baixa == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_data_baixa == "") {?> 
<input class=botao4 type="radio" name="organizar" value="data_baixa" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Data Baixa'); return true;" onMouseOut="nd(); return true;"> Dt. da Baixa <? } } ?></P></TH>

<?/*  DATA PROG. DIÁRIA  */?>
<? if ( $lib_data_prog_diaria == "ver" Or $lib_data_prog_diaria == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_data_prog_diaria == "") {?> 
<input class=botao4 type="radio" name="organizar" value="data_prog_diaria" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Data Prog. Diária'); return true;" onMouseOut="nd(); return true;"> Dt. Prog. Diária <? } } ?></P></TH>
...
<TH align=middle  ><P class=bordas>
<?	if ( $check_data_previsao == "") {?> 
<input class=botao4 type="radio" name="organizar" value="data_previsao" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Data Previsão'); return true;" onMouseOut="nd(); return true;"> Dt. Previsão <? } } ?></P></TH>

<? /* LOCAL VENDA */ ?>
<? if ( $lib_local_venda == "ver" Or $lib_local_venda == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_local_venda == "") {?> 
<input class=botao4 type="radio" name="organizar" value="local_venda" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Local Venda'); return true;" onMouseOut="nd(); return true;"> Local Venda <? } } ?></P></TH>

<? /* FORNECIMENTO MOTOR */ ?>
<? if ( $lib_fornecimento_motor == "ver" Or $lib_fornecimento_motor == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_fornecimento_motor == "") {?> 
<input class=botao4 type="radio" name="organizar" value="fornecimento_motor" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Forn. Motor'); return true;" onMouseOut="nd(); return true;"> Forn. Mot. <? } } ?></P></TH>

<? /* DATA MOTOR RECEBIDO */ ?>
<? if ( $lib_data_motor_recebido == "ver" Or $lib_data_motor_recebido == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if (  $check_data_motor_recebido == "") {?> 
<input class=botao4 type="radio" name="organizar" value="data_motor_recebido" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Data Motor Recebido'); return true;" onMouseOut="nd(); return true;"> Dt. Motor Recebido <? } } ?></P></TH>

<? /* DESCRICAO VENT */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $lib_descr_vent == "ver" Or $lib_descr_vent == "alt" ) { 
	if ( $check_descr_vent == "") {?> 
<input class=botao4 type="radio" name="organizar" value="descr_vent" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Descrição Ventilador'); return true;" onMouseOut="nd(); return true;"> Descr. Vent. <? } } ?></P></TH>

<? /* QT */ ?>
<? if ( $lib_qt == "ver" Or $lib_qt == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_qt == "") {?> 
<input class=botao4 type="radio" name="organizar" value="qt" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar QT'); return true;" onMouseOut="nd(); return true;"> QT <? } } ?></P></TH>

<? /* MODELO */ ?>
<? if ( $lib_modelo == "ver" Or $lib_modelo == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_modelo == "") {?> 
<input class=botao4 type="radio" name="organizar" value="modelo" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Modelo'); return true;" onMouseOut="nd(); return true;"> Mod. <? } } ?></P></TH>

<? /* TAMANHO */ ?>
<? if ( $lib_tamanho == "ver" Or $lib_tamanho == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_tamanho == "") {?> 
<input class=botao4 type="radio" name="organizar" value="tamanho" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Tamanho'); return true;" onMouseOut="nd(); return true;"> Tam. <? } } ?></P></TH>

<? /* ARRANJO */ ?>
<? if ( $lib_arranjo == "ver" Or $lib_arranjo == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_arranjo == "") {?> 
<input class=botao4 type="radio" name="organizar" value="arranjo" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Arranjo'); return true;" onMouseOut="nd(); return true;"> Arr. <? } } ?></P></TH>

<? /* CLASSE */ ?>
<? if ( $lib_classe == "ver" Or $lib_classe == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_classe == "") {?> 
<input class=botao4 type="radio" name="organizar" value="classe" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Classe'); return true;" onMouseOut="nd(); return true;"> Cl. <? } } ?></P></TH>

<? /* ROTACAO */ ?>
<? if ( $lib_rotacao == "ver" Or $lib_rotacao == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_rotacao == "") {?> 
<input class=botao4 type="radio" name="organizar" value="rotacao" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Rotação'); return true;" onMouseOut="nd(); return true;"> Rot. <? } } ?></P></TH>

<? /* GABINETE */ ?>
<? if ( $lib_gab == "ver" Or $lib_gab == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_gab == "") {?>
<input class=botao4 type="radio" name="organizar" value="gab" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Gabinete'); return true;" onMouseOut="nd(); return true;"> Gab. <? } } ?></P></TH>

<? /* PINTURA */ ?>
<? if ( $lib_pintura == "ver" Or $lib_pintura == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_pintura == "") {?> 
<input class=botao4 type="radio" name="organizar" value="pintura" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Pintura'); return true;" onMouseOut="nd(); return true;"> Pint. <? } } ?></P></TH>

<? /* CONSTRUÇÃO */ ?>
<? if ( $lib_construcao == "ver" Or $lib_construcao == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_construcao == "") {?> 
<input class=botao4 type="radio" name="organizar" value="construcao" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Construção'); return true;" onMouseOut="nd(); return true;"> Const. <? } } ?></P></TH>

<? /* VALOR UNITARIO */ ?>
<? if ( $lib_valor_uni == "ver" Or $lib_valor_uni == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_valor_uni == "") {?> 
<input class=botao4 type="radio" name="organizar" value="valor_uni" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Valor Unitário'); return true;" onMouseOut="nd(); return true;"> Valor Un. <? } } ?></P></TH>

<? /* VALOR TOTAL O.S */ ?>
<? if ( $lib_valor_total == "ver" Or $lib_valor_total == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_valor_total == "") {?> 
<input class=botao4 type="radio" name="organizar" value="valor_total" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Valor Total'); return true;" onMouseOut="nd(); return true;"> Sub-Total <? } } ?></P></TH>
...
<TH align=middle  ><P class=bordas>
<? if ( $check_jat_g_fogo == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="ts_jat_g_fogo" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar T. S.'); return true;" onMouseOut="nd(); return true;"> T.S. </P></TH>
<? } ?>

<? /* PROJ OS STATUS */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_jat_g_fogo == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_jat_g_fogo" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Status'); return true;" onMouseOut="nd(); return true;"> Status </P></TH>
<? } ?>

<? /* DT STATUS */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_jat_g_fogo == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="dt_status_jat_g_fogo" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Dt. Status.'); return true;" onMouseOut="nd(); return true;"> Dt. Status </P></TH>
<? } ?>
...
<input class=botao4 type="radio" name="organizar" value="motor_maxsig" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Motor'); return true;" onMouseOut="nd(); return true;"> Mot. <? } } ?></P></TH>

<? /* POLIA MAXSIG */ ?>
<? if ( $lib_polia_maxsig == "ver" Or $lib_polia_maxsig == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_polia_maxsig == "") {?> 
<input class=botao4 type="radio" name="organizar" value="polia_maxsig" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Polia'); return true;" onMouseOut="nd(); return true;"> Pol. <? } } ?></P></TH>

<? /* FUND MAXSIG */ ?>
<? if ( $lib_fund_maxsig == "ver" Or $lib_fund_maxsig == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_fund_maxsig == "") {?> 
<input class=botao4 type="radio" name="organizar" value="fund_maxsig" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Fund.'); return true;" onMouseOut="nd(); return true;"> Fund. <? } } ?></P></TH>
		
<? /* OUTROS MAXSIG */ ?>
<? if ( $lib_outros_maxsig == "ver" Or $lib_outros_maxsig == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_outros_maxsig == "") {?> 
<input class=botao4 type="radio" name="organizar" value="outros_maxsig" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Outros'); return true;" onMouseOut="nd(); return true;"> Outros <? } } ?></P></TH>

<? /* NUMERO CONSULTA CLIENTE */ ?>
<? if ( $lib_n_cons_cliente == "ver" Or $lib_n_cons_cliente == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_n_cons_cliente == "") {?> 
<input class=botao4 type="radio" name="organizar" value="n_cons_cliente" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Nº Cons. Cliente'); return true;" onMouseOut="nd(); return true;"> Nº Cons. Cliente <? } } ?></P></TH>

<? /* OBS */ ?>
<? if ( $lib_obs == "ver" Or $lib_obs == "alt" ) { ?>
<TH align=middle  ><P class=bordas>
<?	if ( $check_obs == "") {?> 
<input class=botao4 type="radio" name="organizar" value="obs" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar OBS'); return true;" onMouseOut="nd(); return true;"> OBS <? } } ?></P></TH> 
...
<TH align=middle  ><P class=bordas>
<? if ( $check_proj == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="proj_os_dt_prog" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Proj. O.S Dt. Prog'); return true;" onMouseOut="nd(); return true;"> Dt. Prog. </P></TH>
<? } ?>

<? /* PROJ OS STATUS */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_proj == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="proj_os_status" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Proj. O.S Status'); return true;" onMouseOut="nd(); return true;"> Status </P></TH>
<? } ?>

<? /* PROJ OS DT ENTRADA */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_proj == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="proj_os_dt_entrada" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Proj. Dt. Entr.'); return true;" onMouseOut="nd(); return true;"> Dt. Em Produção </P></TH>
<? } ?>

<? /* PROJ OS DT SAIDA */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_proj == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="proj_os_dt_saida" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Proj. Dt. Saida'); return true;" onMouseOut="nd(); return true;"> Dt. Expedição
</P></TH>	
...
<TH align=middle  ><P class=bordas>
<? if ( $check_documento == "" ) { ?>
<input class=botao4 type="radio" name="organizar" value="data_book" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Data Book'); return true;" onMouseOut="nd(); return true;"> DB
</P></TH>
<? } ?>
...
<TH align=middle  ><P class=bordas>
<? if ( $check_documento == "" ) { ?>
<input class=botao4 type="radio" name="organizar" value="certif_balanc" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Certif. Balanceamento'); return true;" onMouseOut="nd(); return true;"> CB
</P></TH>
<? } ?>
...
<TH align=middle  ><P class=bordas>
<? if ( $check_documento == "" ) { ?>
<input class=botao4 type="radio" name="organizar" value="certif_materiais" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Certif. Mateirais'); return true;" onMouseOut="nd(); return true;"> CM
</P></TH>
<? } ?>
...
<TH align=middle  ><P class=bordas>
<? if ( $check_documento == "" ) { ?>
<input class=botao4 type="radio" name="organizar" value="desenho_certif" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Desenho Certif.'); return true;" onMouseOut="nd(); return true;"> DC
</P></TH>
<? } ?>
...
<TH align=middle  ><P class=bordas>
<? if ( $check_insp == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="tipo_insp" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Tipo Inspeção'); return true;" onMouseOut="nd(); return true;"> Tipo </P></TH>
<? } ?>

<? /* CÇLIENTE */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_insp == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="cliente_insp" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Cliente Inspeção'); return true;" onMouseOut="nd(); return true;"> Cliente </P></TH>
<? } ?>

<? /* DATA */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_insp == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="data_insp" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Data Inspeção'); return true;" onMouseOut="nd(); return true;"> Data </P></TH>
<? } ?>

<? /* OBS */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_insp == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="obs_insp" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Obs Inspeção'); return true;" onMouseOut="nd(); return true;"> Obs
</P></TH>	
...
<TH align=middle  ><P class=bordas>
<? if ( $check_almox_ver == "" ) { ?>
<input class=botao4 type="radio" name="organizar" value="status_almox" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Almox. Status'); return true;" onMouseOut="nd(); return true;"> Almox. </P></TH>
<? } ?>
	
<? /* USINAGEM EIXO */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_eixo_ver == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_usinagem_eixo" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Usi. Status'); return true;" onMouseOut="nd(); return true;"> Eixo </P></TH>
<? } ?>

<? /* USINAGEM NUC CUBP */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_nuc_cubo_ver == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_usinagem_nuc_cubo" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Usi. Status'); return true;" onMouseOut="nd(); return true;"> Nuc. Cubo </P></TH>
<? } ?>

<? /* USINAGEM POL MOT */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_pol_mot_ver == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_usinagem_pol_mot" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Usi. Status'); return true;" onMouseOut="nd(); return true;"> Pol. Mot. </P></TH>
<? } ?>

<? /* USINAGEM POL Vent */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_pol_vent_ver == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_usinagem_pol_vent" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Usi. Status'); return true;" onMouseOut="nd(); return true;"> Pol. Vent. </P></TH>
<? } ?>
	
<? /* USINAGEM POL Vent */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_gaxeta_ver == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_usinagem_gaxeta" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Usi. Status'); return true;" onMouseOut="nd(); return true;"> Gaxeta </P></TH>
<? } ?>
	
<? /* CORTE */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_corte_ver == "" ) { ?>
<input class=botao4 type="radio" name="organizar" value="status_corte" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Corte Status'); return true;" onMouseOut="nd(); return true;"> Corte </P></TH>
<? } ?>

<? /* CALDERARIA I */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_cald1_ver == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_cald1" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Cald. I Status'); return true;" onMouseOut="nd(); return true;"> Cald. I </P></TH>
<? } ?>

<? /* CALDERARIA 2 */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_cald2_ver == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_cald2" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Cald. II Status'); return true;" onMouseOut="nd(); return true;"> Cald. II </P></TH>
<? } ?>

<? /* ROTOR LL */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_rotorll_ver == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_rotor_ll" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Rot. LL Status'); return true;" onMouseOut="nd(); return true;"> Rot. LL </P></TH>
<? } ?>

<? /* ROTOR SIR */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_rotorsir_ver == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_rotor_sir" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Rot. SIR Status'); return true;" onMouseOut="nd(); return true;"> Rot. SIR </P></TH>
<? } ?>

<? /* MONTAGEM */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_montagem_ver == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_montagem" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Montagem Status'); return true;" onMouseOut="nd(); return true;"> Montagem </P></TH>
<? } ?>

<? /* GABINETE */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_gabinete_ver == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_gabinete" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Gabinete Status'); return true;" onMouseOut="nd(); return true;"> Gabinete </P></TH>
<? } ?>

<? /* BALANCEAMENTO */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_balance_ver == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_balanc" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Balanc. Status'); return true;" onMouseOut="nd(); return true;"> Balanc. </P></TH>
<? } ?>

<? /* PINTURA */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_pintura_ver == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_pintura" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Pintura Status'); return true;" onMouseOut="nd(); return true;"> Pintura </P></TH>
<? } ?>

<? /* EXPEDICAO */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_expedicao_ver == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_expedicao" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Exp. Status'); return true;" onMouseOut="nd(); return true;"> Expedição </P></TH>
<? } ?>

<? /* FUNILARIA */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_funilaria_ver == "" ) { ?>
<input class=botao4 type="radio" name="organizar" value="status_funilaria" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Fun. Status'); return true;" onMouseOut="nd(); return true;"> Funilaria </P></TH>
<? } ?>

<? /* LASER */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_laser_ver == "" ) { ?>
<input class=botao4 type="radio" name="organizar" value="status_laser" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Laser Status'); return true;" onMouseOut="nd(); return true;"> Laser </P></TH>
<? } ?>
...
<TH align=middle  ><P class=bordas>
<?	if ( $check_almox == "" ) { ?>
<input class=botao4 type="radio" name="organizar" value="dt_prog_almox" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Almox. Dt. Prog'); return true;" onMouseOut="nd(); return true;"> Dt. Prog. </P></TH>
<? } ?>

<? /* OS STATUS */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_almox == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_almox" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Almox. Status'); return true;" onMouseOut="nd(); return true;"> Status </P></TH>
<? } ?>

<? /* DT PREVISAO */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_almox == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="dt_previsao_almox" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Almox. Dt Previsão'); return true;" onMouseOut="nd(); return true;"> Dt Previsão </P></TH>
<? } ?>
<? } ?>
...
<TH align=middle  ><P class=bordas>
<?	if ( $check_corte == "" ) { ?>
<input class=botao4 type="radio" name="organizar" value="dt_prog_corte" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Corte Dt. Prog'); return true;" onMouseOut="nd(); return true;"> Dt. Prog. </P></TH>
<? } ?>

<? /* OS STATUS */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_corte == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_corte" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Corte Status'); return true;" onMouseOut="nd(); return true;"> Status </P></TH>
<? } ?>

<? /* DT PREVISAO */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_corte == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="dt_previsao_corte" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Corte Dt Previsão'); return true;" onMouseOut="nd(); return true;"> Dt Previsão </P></TH>
<? } ?>
<? } ?>
...
<TH align=middle  ><P class=bordas>
<?	if ( $check_balanc == "" ) { ?>
<input class=botao4 type="radio" name="organizar" value="dt_prog_balanc" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Balanc. Dt. Prog'); return true;" onMouseOut="nd(); return true;"> Dt. Prog. </P></TH>
<? } ?>

<? /* STATUS */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_balanc == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_balanc" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Balanc. Status'); return true;" onMouseOut="nd(); return true;"> Status </P></TH>
<? } ?>

<? /* DT PREVISAO */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_balanc == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="dt_previsao_balanc" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Balanc. Dt Previsão'); return true;" onMouseOut="nd(); return true;"> Dt Previsão </P></TH>
<? } ?>
<?  } ?>
...
<TH align=middle  ><P class=bordas>
<?	if ( $check_cald1 == "" ) { ?>
<input class=botao4 type="radio" name="organizar" value="dt_prog_cald1" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Cald. I Dt. Prog'); return true;" onMouseOut="nd(); return true;"> Dt. Prog. </P></TH>
<? } ?>

<? /* OS STATUS */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_cald1 == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_cald1" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Cald. I Status'); return true;" onMouseOut="nd(); return true;"> Status </P></TH>
<? } ?>

<? /* DT PREVISAO */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_cald1 == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="dt_previsao_cald1" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Cald. I Dt Previsão'); return true;" onMouseOut="nd(); return true;"> Dt Previsão </P></TH>
<? } ?>
...
<TH align=middle  ><P class=bordas>
<?	if ( $check_cald2 == "" ) { ?>
<input class=botao4 type="radio" name="organizar" value="dt_prog_cald2" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Cald. II Dt. Prog'); return true;" onMouseOut="nd(); return true;"> Dt. Prog. </P></TH>
<? } ?>

<? /* OS STATUS */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_cald2 == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_cald2" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Cald. II Status'); return true;" onMouseOut="nd(); return true;"> Status </P></TH>
<? } ?>

<? /* DT PREVISAO */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_cald2 == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="dt_previsao_cald2" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Cald. II Dt Previsão'); return true;" onMouseOut="nd(); return true;"> Dt Previsão </P></TH>
<? } ?>
...
<input class=botao4 type="radio" name="organizar" value="dt_prog_pintura" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Pintura Dt. Prog'); return true;" onMouseOut="nd(); return true;"> Dt. Prog. </P></TH>
<? } ?>

<? /* OS STATUS */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_pinturasetor == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_pintura" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Pintura Status'); return true;" onMouseOut="nd(); return true;"> Status </P></TH>
<? } ?>

<? /* DT PREVISAO */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_pinturasetor == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="dt_previsao_pintura" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Pintura Dt Previsão'); return true;" onMouseOut="nd(); return true;"> Dt Previsão </P></TH>
<? } ?>
...
<TH align=middle  ><P class=bordas>
<?	if ( $check_rotor_ll == "" ) { ?>
<input class=botao4 type="radio" name="organizar" value="dt_prog_rotor_ll" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Rotor LL Dt. Prog'); return true;" onMouseOut="nd(); return true;"> Dt. Prog. </P></TH>
<? } ?>

<? /* OS STATUS */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_rotor_ll == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_rotor_ll" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Rotor LL Status'); return true;" onMouseOut="nd(); return true;"> Status </P></TH>
<? } ?>

<? /* DT PREVISAO */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_rotor_ll == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="dt_previsao_rotor_ll" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Rotor LL Dt Previsão'); return true;" onMouseOut="nd(); return true;"> Dt Previsão </P></TH>
<? } ?>
...
<TH align=middle  ><P class=bordas>
<?	if ( $check_rotor_sir == "" ) { ?>
<input class=botao4 type="radio" name="organizar" value="dt_prog_rotor_sir" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Rotor SIR Dt. Prog'); return true;" onMouseOut="nd(); return true;"> Dt. Prog. </P></TH>
<? } ?>

<? /* OS STATUS */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_rotor_sir == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_rotor_sir" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Rotor SIR Status'); return true;" onMouseOut="nd(); return true;"> Status </P></TH>
<? } ?>

<? /* DT PREVISAO */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_rotor_sir == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="dt_previsao_rotor_sir" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Rotor SIR Dt Previsão'); return true;" onMouseOut="nd(); return true;"> Dt Previsão </P></TH>
<? } ?>
...
<TH align=middle  ><P class=bordas>
<?	if ( $check_montagem == "" ) { ?>
<input class=botao4 type="radio" name="organizar" value="dt_prog_montagem" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Montagem Dt. Prog'); return true;" onMouseOut="nd(); return true;"> Dt. Prog. </P></TH>
<? } ?>

<? /* OS STATUS */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_montagem == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_montagem" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Montagem Status'); return true;" onMouseOut="nd(); return true;"> Status </P></TH>
<? } ?>

<? /* DT PREVISAO */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_montagem == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="dt_previsao_montagem" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Montagem Dt Previsão'); return true;" onMouseOut="nd(); return true;"> Dt Previsão </P></TH>
<? } ?>
...
<input class=botao4 type="radio" name="organizar" value="dt_prog_usinagem_eixo" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Usi. Dt. Prog'); return true;" onMouseOut="nd(); return true;"> Dt. Prog. </P></TH>
<? } ?>
<? /* STATUS */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_usinagem_eixo == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_usinagem_eixo" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Usi. Status'); return true;" onMouseOut="nd(); return true;"> Status </P></TH>
<? } ?>

<? /* DT PREVISAO */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_usinagem_eixo == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="dt_previsao_usinagem_eixo" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Usi. Dt Previsão'); return true;" onMouseOut="nd(); return true;"> Dt Previsão </P></TH>
<? } ?>
...
<input class=botao4 type="radio" name="organizar" value="dt_prog_usinagem_nuc_cubo" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Usi. Dt. Prog'); return true;" onMouseOut="nd(); return true;"> Dt. Prog. </P></TH>
<? } ?>

<? /* STATUS */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_usinagem_nuc_cubo == "" ) { ?>
<input class=botao4 type="radio" name="organizar" value="status_usinagem_nuc_cubo" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Usi. Status'); return true;" onMouseOut="nd(); return true;"> Status </P></TH>
<? } ?>

<? /* DT PREVISAO */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_usinagem_nuc_cubo == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="dt_previsao_usinagem_nuc_cubo" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Usi. Dt Previsão'); return true;" onMouseOut="nd(); return true;"> Dt Previsão </P></TH>
<? } ?>
...
<input class=botao4 type="radio" name="organizar" value="dt_prog_usinagem_pol_mot" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Usi. Dt. Prog'); return true;" onMouseOut="nd(); return true;"> Dt. Prog. </P></TH>
<? } ?>

<? /* STATUS */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_usinagem_pol_mot == "" ) { ?>
<input class=botao4 type="radio" name="organizar" value="status_usinagem_pol_mot" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Usi. Status'); return true;" onMouseOut="nd(); return true;"> Status </P></TH>
<? } ?>

<? /* DT PREVISAO */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_usinagem_pol_mot == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="dt_previsao_usinagem_pol_mot" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Usi. Dt Previsão'); return true;" onMouseOut="nd(); return true;"> Dt Previsão </P></TH>
<? } ?>
...
<input class=botao4 type="radio" name="organizar" value="dt_prog_usinagem_pol_vent" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Usi. Dt. Prog'); return true;" onMouseOut="nd(); return true;"> Dt. Prog. </P></TH>
<? } ?>

<? /* STATUS */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_usinagem_pol_vent == "" ) { ?>
<input class=botao4 type="radio" name="organizar" value="status_usinagem_pol_vent" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Usi. Status'); return true;" onMouseOut="nd(); return true;"> Status </P></TH>
<? } ?>

<? /* DT PREVISAO */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_usinagem_pol_vent == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="dt_previsao_usinagem_pol_vent" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Usi. Dt Previsão'); return true;" onMouseOut="nd(); return true;"> Dt Previsão </P></TH>
<? } ?>
...
<input class=botao4 type="radio" name="organizar" value="dt_prog_usinagem_gaxeta" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Usi. Dt. Prog'); return true;" onMouseOut="nd(); return true;"> Dt. Prog. </P></TH>
<? } ?>

<? /* STATUS */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_usinagem_gaxeta == "" ) { ?>
<input class=botao4 type="radio" name="organizar" value="status_usinagem_gaxeta" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Usi. Status'); return true;" onMouseOut="nd(); return true;"> Status </P></TH>
<? } ?>

<? /* DT PREVISAO */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_usinagem_gaxeta == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="dt_previsao_usinagem_gaxeta" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Usi. Dt Previsão'); return true;" onMouseOut="nd(); return true;"> Dt Previsão </P></TH>
<? } ?>
...
<TH align=middle  ><P class=bordas>
<?	if ( $check_expedicao == "" ) { ?>
<input class=botao4 type="radio" name="organizar" value="dt_prog_expedicao" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Exp. Dt. Prog'); return true;" onMouseOut="nd(); return true;"> Dt. Prog. </P></TH>
<? } ?>

<? /* OS STATUS */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_expedicao == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_expedicao" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Exp. Status'); return true;" onMouseOut="nd(); return true;"> Status </P></TH>
<? } ?>

<? /* DT PREVISAO */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_expedicao == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="dt_previsao_expedicao" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Exp. Dt Previsão'); return true;" onMouseOut="nd(); return true;"> Dt Previsão </P></TH>
<? } ?>
<? } ?>
...
<TH align=middle  ><P class=bordas>
<?	if ( $check_funilaria == "" ) { ?>
<input class=botao4 type="radio" name="organizar" value="dt_prog_funilaria" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Fun. Dt. Prog'); return true;" onMouseOut="nd(); return true;"> Dt. Prog. </P></TH>
<? } ?>

<? /* OS STATUS */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_funilaria == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_funilaria" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Fun. Status'); return true;" onMouseOut="nd(); return true;"> Status </P></TH>
<? } ?>

<? /* DT PREVISAO */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_funilaria == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="dt_previsao_funilaria" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Fun. Dt Previsão'); return true;" onMouseOut="nd(); return true;"> Dt Previsão </P></TH>
<? } ?>
<? } ?>
...
<TH align=middle  ><P class=bordas>
<?	if ( $check_laser == "" ) { ?>
<input class=botao4 type="radio" name="organizar" value="dt_prog_laser" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Laser Dt. Prog'); return true;" onMouseOut="nd(); return true;"> Dt. Prog. </P></TH>
<? } ?>

<? /* OS STATUS */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_laser == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="status_laser" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Laser Status'); return true;" onMouseOut="nd(); return true;"> Status </P></TH>
<? } ?>

<? /* DT PREVISAO */ ?>
<TH align=middle  ><P class=bordas>
<? if ( $check_laser == "" ) {?>
<input class=botao4 type="radio" name="organizar" value="dt_previsao_laser" onClick="Atualizar_Dados_PCP_Antigos();" onMouseOver="drc('','Organizar Laser Dt Previsão'); return true;" onMouseOut="nd(); return true;"> Dt Previsão </P></TH>
<? } ?>
<? } ?>
...
<select <?echo $botao?> size="1" name="f_data_emissao"  style='width:95px'>
 <?
  $query = "select distinct data_emissao from Antigos where id>='0' $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_representante_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_almox_db $f_status_almox_db $f_dt_prog_corte_db $f_status_corte_db dt_prog_laser_db $f_status_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by data_emissao";
...
<select <?echo $botao?> size="1" name="f_data_emissao_mes"  style='width:95px'>
 <?
  $query = "select distinct data_emissao from Antigos where id>='0' $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_representante_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_mes_db $f_data_baixa_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by data_emissao";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
  	$data_emissao_port = $sRow->data_emissao; 
...
<select <?echo $botao?> size="1" name="f_nome_cliente"  style='width:150px'>
 <?
  $query = "select distinct nome_cliente from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by nome_cliente";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_oc_obra"  style='width:125px'>
 <?
  $query = "select distinct oc_obra from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by oc_obra";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_mercado"  style='width:65px'>
 <?
  $query = "select distinct mercado from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db  $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by mercado";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_representante"  style='width:80px'>
 <?
  $query = "select distinct representante from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by mercado";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<? if ( $check_estado == "") { 
 ...
 <?
  $query = "select distinct estado from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by estado";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_data_entrega"  style='width:95px'>
 <?
  $query = "select distinct data_entrega from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_representante_db $f_estado_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by data_entrega";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_reprogramacao"  style='width:95px'>
 <?
  $query = "select distinct reprogramacao from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db   $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by reprogramacao";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_baixa"  style='width:40px'>
 <?
  $query = "select distinct baixa from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by baixa";
  $result = MYSQL_QUERY($query);
...
<select <?echo $botao?> size="1" name="f_data_baixa"  style='width:95px'>
 <?
  $query = "select distinct data_baixa from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db  $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by data_baixa";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_data_baixa_mes"  style='width:95px'>
 <?
  $query = "select distinct data_baixa from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by data_baixa";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_data_prog_diaria"  >
 <?
  $query = "select distinct data_prog_diaria from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_local_venda_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db  $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by data_prog_diaria";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_data_previsao"  >
 <?
  $query = "select distinct data_previsao from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_local_venda_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_data_prog_diaria_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db  $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by data_previsao";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_local_venda"  style='width:65px'>
 <?
  $query = "select distinct local_venda from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by local_venda";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_fornecimento_motor"  style='width:35px'>
 <?
  $query = "select distinct fornecimento_motor from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by fornecimento_motor";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_data_motor_recebido"  style='width:95px'>
 <?
  $query = "select distinct data_motor_recebido from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by data_motor_recebido";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_descr_vent"  style='width:125px'>
 <?
  $query = "select distinct descr_vent from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by descr_vent";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_qt"  style='width:45px'>
 <?
  $query = "select distinct qt from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by qt";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
  if ($sRow->qt==$f_qt)   {
...
<select <?echo $botao?> size="1" name="f_modelo" style='width:55px'>
 <?
  $query = "select distinct modelo from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by modelo";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_tamanho"  style='width:55px'>
 <?
  $query = "select distinct tamanho from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by tamanho";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_arranjo"  style='width:35px'>
 <?
  $query = "select distinct arranjo from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by arranjo";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_classe"  style='width:45px'>
 <?
  $query = "select distinct classe from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by classe";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_rotacao"  style='width:45px'>
 <?
  $query = "select distinct rotacao from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by rotacao";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_gab"  style='width:35px'>
 <?
  $query = "select distinct gab from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by gab";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
  if ($sRow->gab==$f_gab)   {
...
<select <?echo $botao?> size="1" name="f_pintura"  style='width:65px'>
 <?
  $query = "select distinct pintura from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by pintura";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_construcao"  style='width:45px'>
 <?
  $query = "select distinct construcao from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by construcao";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_valor_uni"  style='width:95px'>
 <?
  $query = "select distinct valor_uni from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by valor_uni";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_valor_total"  style='width:95px'>
 <?
  $query = "select distinct valor_total from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_laser_db $f_status_laser_db $f_obs_laser_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by valor_total";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_ts_jat_g_fogo"  style='width:40px'>
 <?
  $query = "select distinct ts_jat_g_fogo from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_status_jat_g_fogo_db $f_dt_status_jat_g_fogo_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by ts_jat_g_fogo";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_status_jat_g_fogo"  style='width:40px'>
 <?
  $query = "select distinct status_jat_g_fogo from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_ts_jat_g_fogo_db $f_dt_status_jat_g_fogo_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by status_jat_g_fogo";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_dt_status_jat_g_fogo"  style='width:95px'>
 <?
  $query = "select distinct dt_status_jat_g_fogo from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_status_jat_g_fogo_db $f_dt_status_jat_g_fogo_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by dt_status_jat_g_fogo";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<TH align=middle widht="15%" ><P class=bordas>
<?	if ( $check_motor_maxsig == "") {
		if ( $f_motor_maxsig == "") {$botao = "";} else {$botao = "class=select_filtrado";} ?>
<select <?echo $botao?> size="1" name="f_motor_maxsig"  style='width:40px'>
 <?
  $query = "select distinct motor_maxsig from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db  $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by motor_maxsig";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
  if ($sRow->motor_maxsig==$f_motor_maxsig)   {
  $sSelect = "SELECTED";
  }  else  {
  $sSelect = "";
  }  print("<option value='$sRow->motor_maxsig' $sSelect> $sRow->motor_maxsig</option>");   }  ?>
</select>
<? } } ?>
</P></TH>
...
<TH align=middle widht="15%" ><P class=bordas>
<?	if ( $check_polia_maxsig == "") {
		if ( $f_polia_maxsig == "") {$botao = "";} else {$botao = "class=select_filtrado";} ?>
<select <?echo $botao?> size="1" name="f_polia_maxsig"  style='width:40px'>
 <?
  $query = "select distinct polia_maxsig from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db  $f_motor_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by polia_maxsig";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
  if ($sRow->polia_maxsig==$f_polia_maxsig)   {
  $sSelect = "SELECTED";
  }  else  {
  $sSelect = "";
  }  print("<option value='$sRow->polia_maxsig' $sSelect> $sRow->polia_maxsig</option>");   }  ?>
</select>
<? } } ?>
</P></TH>
...
<TH align=middle widht="15%" ><P class=bordas>
<?	if ( $check_fund_maxsig == "") {
		if ( $f_fund_maxsig == "") {$botao = "";} else {$botao = "class=select_filtrado";} ?>
<select <?echo $botao?> size="1" name="f_fund_maxsig"  style='width:40px'>
 <?
  $query = "select distinct fund_maxsig from pcp where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db  $f_motor_maxsig_db $f_polia_maxsig_db $f_outros_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by fund_maxsig";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
  if ($sRow->fund_maxsig==$f_fund_maxsig)   {
  $sSelect = "SELECTED";
  }  else  {
  $sSelect = "";
  }  print("<option value='$sRow->fund_maxsig' $sSelect> $sRow->fund_maxsig</option>");   }  ?>
</select>
<? } } ?>
</P></TH>
...
<TH align=middle widht="15%" ><P class=bordas>
<?	if ( $check_outros_maxsig == "") {
		if ( $f_outros_maxsig == "") {$botao = "";} else {$botao = "class=select_filtrado";} ?>
<select <?echo $botao?> size="1" name="f_outros_maxsig"  style='width:40px'>
 <?
  $query = "select distinct outros_maxsig from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db  $f_motor_maxsig_db $f_polia_maxsig_db $f_fund_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by outros_maxsig";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
  if ($sRow->outros_maxsig==$f_outros_maxsig)   {
  $sSelect = "SELECTED";
  }  else  {
  $sSelect = "";
  }  print("<option value='$sRow->outros_maxsig' $sSelect> $sRow->outros_maxsig</option>");   }  ?>
</select>
<? } } ?>
</P></TH>
...
<select <?echo $botao?> size="1" name="f_n_cons_cliente"  style='width:40px'>
 <?
  $query = "select distinct n_cons_cliente from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db  $f_motor_maxsig_db $f_polia_maxsig_db $f_fund_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by n_cons_cliente";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_obs"  style='width:250px'>
 <?
  $query = "select distinct obs from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by obs";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
  if ($sRow->obs==$f_obs)   {
...
<select <?echo $botao?> size="1" name="f_proj_os_dt_prog"  style='width:95px'>
 <?
  $query = "select distinct proj_os_dt_prog from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by proj_os_dt_prog";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_proj_os_status"  style='width:40px'>
 <?
  $query = "select distinct proj_os_status from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by proj_os_status";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_proj_os_dt_entrada"  style='width:95px'>
 <?
  $query = "select distinct proj_os_dt_entrada from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by proj_os_dt_entrada";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_proj_os_dt_saida"  style='width:95px'>
 <?
  $query = "select distinct proj_os_dt_saida from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by proj_os_dt_saida";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
$proj_os_dt_saida = $sRow->proj_os_dt_saida;
...
{$proj_os_dt_saida = ($dia_proj_os_dt_saida."/".$mes_proj_os_dt_saida."/".$ano_proj_os_dt_saida); }
  print("<option value='$sRow->proj_os_dt_saida' $sSelect>  $proj_os_dt_saida </option>");   
}  ?>
</select>
</P></TH>
<? } ?>
...
<select <?echo $botao?> size="1" name="f_data_book"  style='width:40px'>
 <?
  $query = "select distinct data_book from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by data_book";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_certif_balanc"  style='width:40px'>
 <?
  $query = "select distinct certif_balanc from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by certif_balanc";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_certif_materiais"  style='width:40px'>
 <?
  $query = "select distinct certif_materiais from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by certif_materiais";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_desenho_certif"  style='width:40px'>
 <?
  $query = "select distinct desenho_certif from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by desenho_certif";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_tipo_insp"  style='width:40px'>
 <?
  $query = "select distinct tipo_insp from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by tipo_insp";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_cliente_insp"  style='width:40px'>
 <?
  $query = "select distinct cliente_insp from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by cliente_insp";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_data_insp"  style='width:95px'>
 <?
  $query = "select distinct data_insp from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by data_insp";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_obs_insp"  style='width:200px'>
 <?
  $query = "select distinct obs_insp from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by obs_insp";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<?
$query = "select distinct status_usinagem_eixo from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db order by status_usinagem_eixo";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<?
$query = "select distinct status_gabinete from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_status_corte_db $f_status_balanc_db $f_status_cald1_db $f_status_rotor_ll_db $f_status_rotor_sir_db $f_status_montagem_db $f_status_usinagem_eixo_db $f_status_usinagem_nuc_cubo_db $f_status_usinagem_pol_mot_db $f_status_usinagem_pol_vent_db $f_status_usinagem_gaxeta_db order by status_gabinete";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_dt_prog_almox"  style='width:90px'>
 <?
  $query = "select distinct dt_prog_almox from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_status_almox_db $f_obs_almox_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by dt_prog_almox";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_dt_prog_corte"  style='width:90px'>
 <?
  $query = "select distinct dt_prog_corte from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by dt_prog_corte";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_dt_prog_balanc"  style='width:90px'>
 <?
  $query = "select distinct dt_prog_balanc from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by dt_prog_balanc";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_dt_prog_cald1"  style='width:90px'>
 <?
  $query = "select distinct dt_prog_cald1 from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db  $f_status_balanc_db $f_status_cald1_db $f_dt_previsao_cald1_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by dt_prog_cald1";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_dt_prog_pintura"  style='width:90px'>
 <?
  $query = "select distinct dt_prog_pintura from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_status_corte_db $f_status_corte_db $f_dt_prog_balanc_db $f_status_balanc_db $f_dt_previsao_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db $f_status_pintura_db $f_dt_previsao_pintura_db order by dt_prog_pintura";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_dt_prog_rotor_ll"  style='width:90px'>
 <?
  $query = "select distinct dt_prog_rotor_ll from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db  $f_status_balanc_db $f_status_cald1_db $f_dt_previsao_cald1_db $f_status_cald2_db $f_dt_previsao_cald1_db $f_status_rotor_ll_db $f_dt_previsao_rotor_ll_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by dt_prog_rotor_ll";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_dt_prog_rotor_sir"  style='width:90px'>
 <?
  $query = "select distinct dt_prog_rotor_sir from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db  $f_status_balanc_db $f_status_cald1_db $f_dt_previsao_cald1_db $f_status_cald2_db $f_dt_previsao_cald1_db $f_status_rotor_ll_db $f_dt_previsao_rotor_ll_db $f_status_rotor_sir_db $f_dt_previsao_rotor_sir_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by dt_prog_rotor_sir";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_dt_prog_montagem"  style='width:90px'>
 <?
  $query = "select distinct dt_prog_montagem from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db  $f_status_balanc_db $f_status_cald1_db $f_dt_previsao_cald1_db $f_status_cald2_db $f_dt_previsao_cald1_db $f_status_rotor_ll_db $f_dt_previsao_rotor_ll_db $f_dt_previsao_montagem_db $f_status_montagem_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db order by dt_prog_montagem";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_dt_prog_usinagem_eixo"  style='width:90px'>
 <?
  $query = "select distinct dt_prog_usinagem_eixo from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_status_balanc_db $f_obs_balanc_db $f_status_usinagem_eixo_db order by dt_prog_usinagem_eixo";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_dt_prog_usinagem_nuc_cubo"  style='width:90px'>
 <?
  $query = "select distinct dt_prog_usinagem_nuc_cubo from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db $f_status_usinagem_nuc_cubo_db order by dt_prog_usinagem_nuc_cubo";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_dt_prog_usinagem_pol_mot"  style='width:90px'>
 <?
  $query = "select distinct dt_prog_usinagem_pol_mot from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db $f_dt_prog_usinagem_nuc_cubo_db $f_status_usinagem_nuc_cubo_db $f_status_usinagem_pol_mot_db order by dt_prog_usinagem_pol_mot";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_dt_prog_usinagem_pol_vent"  style='width:90px'>
 <?
  $query = "select distinct dt_prog_usinagem_pol_vent from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db $f_dt_prog_usinagem_nuc_cubo_db $f_status_usinagem_nuc_cubo_db $f_dt_prog_usinagem_pol_mot_db $f_status_usinagem_pol_mot_db $f_status_usinagem_pol_vent_db order by dt_prog_usinagem_pol_vent";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_dt_prog_usinagem_gaxeta"  style='width:90px'>
 <?
  $query = "select distinct dt_prog_usinagem_gaxeta from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_dt_prog_corte_db $f_status_corte_db $f_obs_corte_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db $f_dt_prog_usinagem_nuc_cubo_db $f_status_usinagem_nuc_cubo_db $f_dt_prog_usinagem_pol_mot_db $f_status_usinagem_pol_mot_db $f_dt_prog_usinagem_pol_vent_db $f_status_usinagem_pol_vent_db $f_status_usinagem_gaxeta_db order by dt_prog_usinagem_gaxeta";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
...
<select <?echo $botao?> size="1" name="f_dt_prog_expedicao"  style='width:90px'>
 <?
  $query = "select distinct dt_prog_expedicao from Antigos where id>='0' $f_data_emissao_db $f_data_emissao_mes_db $f_num_os_db $f_num_proposta_db $f_nome_cliente_db $f_oc_obra_db $f_mercado_db $f_estado_db $f_data_entrega_db $f_data_entrega_mes_db $f_data_prog_diaria_db $f_local_venda_db $f_fornecimento_motor_db $f_descr_vent_db $f_modelo_db $f_tamanho_db $f_arranjo_db $f_classe_db $f_rotacao_db $f_gab_db $f_pintura_db $f_contrucao_db $f_qt_db $f_valor_uni_db $f_valor_total_db $f_obs_db $f_motor_maxsig_db $f_polia_maxsig_db $f_carcaca_maxsig_db $f_rotor_maxsig_db $f_data_motor_recebido_db $f_reprogramacao_db $f_baixa_db $f_data_baixa_mes_db $f_data_baixa_db $f_proj_os_dt_prog_db $f_proj_os_status_db $f_proj_os_dt_entrada_db $f_proj_os_dt_saida_db $f_data_book_db $f_certif_balanc_db $f_certif_materiais_db $f_desenho_certif_db $f_status_almox_db $f_obs_almox_db $f_status_corte_db $f_obs_corte_db $f_dt_prog_balanc_db $f_status_balanc_db $f_obs_balanc_db $f_dt_prog_usinagem_eixo_db $f_status_usinagem_eixo_db $f_status_expedicao_db $f_previsao_expedicao_db order by dt_prog_expedicao";
  $result = MYSQL_QUERY($query);
  print("<option value='' $sSelect>TODOS</option>");
  while ($sRow = mysql_fetch_object($result)) {
