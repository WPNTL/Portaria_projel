...
if ($lib_mat1 == "alt"){
	if ($tipo_mat1 == "item") { 
$sql = "UPDATE pcp SET data_emissao_alt=NOW(), mat1='$mat1_novo' ,usuario_alt='$usuario_alt' WHERE id='$id'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar - motor_maxsig!!!");  } 
	if ($tipo_mat1 == "os") {
$sql = "UPDATE pcp SET data_emissao_alt=NOW(), mat1='$mat1_novo' ,usuario_alt='$usuario_alt' WHERE num_os='$num_os_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar - motor_maxsig!!!"); } 
}

/* POLIA MAXSIG */
if ($lib_mat2 == "alt"){
	if ($tipo_mat2 == "item") { 
$sql = "UPDATE pcp SET data_emissao_alt=NOW(), mat2='$mat2_novo' ,usuario_alt='$usuario_alt' WHERE id='$id'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar - polia_maxsig!!!");  } 
	if ($tipo_mat2 == "os") {
$sql = "UPDATE pcp SET data_emissao_alt=NOW(), mat2='$mat2_novo' ,usuario_alt='$usuario_alt' WHERE num_os='$num_os_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar - polia_maxsig!!!"); }
}

/* FUND MAXSIG */
if ($lib_mat3 == "alt"){
	if ($tipo_mat3 == "item") { 
$sql = "UPDATE pcp SET data_emissao_alt=NOW(), mat3='$mat3_novo' ,usuario_alt='$usuario_alt' WHERE id='$id'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar - FUND_maxsig!!!");  } 
	if ($tipo_mat3 == "os") {
$sql = "UPDATE pcp SET data_emissao_alt=NOW(), mat3='$mat3_novo' ,usuario_alt='$usuario_alt' WHERE num_os='$num_os_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar - FUND_maxsig!!!"); }
}

/* OUTROS MAXSIG */
if ($lib_outros == "alt"){
	if ($tipo_outros == "item") { 
$sql = "UPDATE pcp SET data_emissao_alt=NOW(), outros='$outros_novo' ,usuario_alt='$usuario_alt' WHERE id='$id'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar - outros_maxsig!!!");  } 
	if ($tipo_outros == "os") {
$sql = "UPDATE pcp SET data_emissao_alt=NOW(), outros='$outros_novo' ,usuario_alt='$usuario_alt' WHERE num_os='$num_os_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar - outros_maxsig!!!"); } 
}
