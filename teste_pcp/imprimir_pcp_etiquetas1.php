...
/*  ----------------	BUSCAR DADOS DE LIBERAÇÃO ------------------	*/
?>
<form action="imprimir_etiquetas.php?<?echo $tipo_busca?><?echo $tipo_busca2?><?echo $valor?><?echo $valor2?>" method="post" name="imprimir_pcp_etiquetas">
...
<? if ( $lib_num_os == "ver" Or $libnum_os == "alt" ) { ?>
<TH align=middle rowspan="1"><P class=bordas>	
<? if ( $check_num_os == "" ) { ?> 
<input type='checkbox' value='' name='opcao' onClick="seleciona()"> Selec. todos<? } } ?></P></TH>
...
<TH align=middle  rowspan="1"><P class=bordas>
<?	if ( $check_tag == "") {?>
<input class=botao4 type="radio" name="organizar" value="tag" onClick="Atualizar_Dados_PCP_Altera();" onMouseOver="drc('','Organizar Tag'); return true;" onMouseOut="nd(); return true;"> TAG <? } } ?></P></TH>
...
<input type="checkbox" name="opcoes[]" value="<?echo $id?>" >
</P></TD>
...
<?	if ( $check_num_os == "" ) { ?>
<span style="width:40px;word-wrap:break-word;"> 
   <input class=left size="20" name=tag_novo[<?echo$x;?>] onchange="this.value = this.value.toUpperCase();">
</span>
<? } } ?>
</P></TD>
