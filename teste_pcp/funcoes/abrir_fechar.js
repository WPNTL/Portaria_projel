...
function Abrir_imprimir_etiquetas() { with(document.pcp)   { javascript:void(open('imprimir_pcp_etiquetas.php','principal_altera','scrollbars=yes,fullscreen=yes')); } }

function Abrir_PCP_Painel_Montagem() { with(document.pcp)   { javascript:void(open('painel_montagem.php','principal3','scrollbars=yes,fullscreen=yes')); } }
