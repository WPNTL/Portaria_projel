...
$end_final   =  "Imprimir PCP Previsão Diária.pdf"; 
//TIPO DO PDF GERADO                                      
//F-> SALVA NO ENDEREÇO ESPECIFICADO NA VAR END_FINAL     
$tipo_pdf    =  "F";                          
//TÍTULO DO RELATÓRIO                                     
$titulo      =  "Imprimir PCP Previsão Diária";
...
//	$pdf->Cell(40, -15, "Data Impressão - $data_emissao_hoje" , 0, 0, 'R');    
	$pdf->Cell(180, -15, "Impressão PCP Previsão por Dia" , 0, 0, 'C');
...
//MONTA O SUB-TITULO 
   $pdf->Ln(1); 
   $pdf->SetFont("Arial", "B", $fonte_cabecalho);
   $pdf->Cell(45, 8, "Data Previsão Montagem $data_previsao - $dia_semana", 0, 1, 'L');   
...
if ( $f_data_previsao == "" ) {
   ...
   $pdf->Cell(180, 10, "VOCÊ NÃO SELECIONOU A DATA PREVISAO", 1, 1, 'C'); 
