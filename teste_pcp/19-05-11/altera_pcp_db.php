...
$sql = "UPDATE pcp SET data_emissao_alt=NOW(), motor_maxsig='$motor_maxsig_novo' ,usuario_alt='$usuario_alt' WHERE id='$id'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar - motor_maxsig!!!");  } 
	if ($tipo_motor_maxsig == "os") {
$sql = "UPDATE pcp SET data_emissao_alt=NOW(), motor_maxsig='$motor_maxsig_novo' ,usuario_alt='$usuario_alt' WHERE num_os='$num_os_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar - motor_maxsig!!!"); } 
}

/* POLIA MAXSIG */
if ($lib_polia_maxsig == "alt"){
	if ($tipo_polia_maxsig == "item") { 
$sql = "UPDATE pcp SET data_emissao_alt=NOW(), polia_maxsig='$polia_maxsig_novo' ,usuario_alt='$usuario_alt' WHERE id='$id'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar - polia_maxsig!!!");  } 
	if ($tipo_polia_maxsig == "os") {
$sql = "UPDATE pcp SET data_emissao_alt=NOW(), polia_maxsig='$polia_maxsig_novo' ,usuario_alt='$usuario_alt' WHERE num_os='$num_os_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar - polia_maxsig!!!"); }
}

/* FUND MAXSIG */
if ($lib_fund_maxsig == "alt"){
	if ($tipo_fund_maxsig == "item") { 
$sql = "UPDATE pcp SET data_emissao_alt=NOW(), fund_maxsig='$fund_maxsig_novo' ,usuario_alt='$usuario_alt' WHERE id='$id'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar - FUND_maxsig!!!");  } 
	if ($tipo_fund_maxsig == "os") {
$sql = "UPDATE pcp SET data_emissao_alt=NOW(), fund_maxsig='$fund_maxsig_novo' ,usuario_alt='$usuario_alt' WHERE num_os='$num_os_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar - FUND_maxsig!!!"); }
}

/* OUTROS MAXSIG */
if ($lib_outros_maxsig == "alt"){
	if ($tipo_outros_maxsig == "item") { 
$sql = "UPDATE pcp SET data_emissao_alt=NOW(), outros_maxsig='$outros_maxsig_novo' ,usuario_alt='$usuario_alt' WHERE id='$id'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar - outros_maxsig!!!");  } 
	if ($tipo_outros_maxsig == "os") {
$sql = "UPDATE pcp SET data_emissao_alt=NOW(), outros_maxsig='$outros_maxsig_novo' ,usuario_alt='$usuario_alt' WHERE num_os='$num_os_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar - outros_maxsig!!!"); } 
}
...
$proxima_prog_montagem = mktime(0, 0, 0, date("$mes_dt_prog_montagem"), date("$dia_dt_prog_montagem") + 1, date("$ano_dt_prog_montagem"));
$proxima_prog_montagem1 = date("m/d/Y",  $proxima_prog_montagem);

$proxima_prog_montagem3 = mktime(0, 0, 0, date("$mes_dt_prog_montagem"), date("$dia_dt_prog_montagem") + 2, date("$ano_dt_prog_montagem"));
$proxima_prog_montagem2 = date("m/d/Y",  $proxima_prog_montagem3);
...
if ( $gab == "" OR $gab == "-" ) {
	...
	if ($tipo_dt_prog_montagem == "item") { 
$sql = "UPDATE pcp SET data_emissao_alt=NOW(), dt_prog_montagem='$dt_prog_montagem_novo', usuario_alt='$usuario_alt' WHERE id='$id'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar dt_prog_montagem!!!");  } 
	if ($tipo_dt_prog_montagem == "os") {
$sql = "UPDATE pcp SET data_emissao_alt=NOW(), dt_prog_montagem='$dt_prog_montagem_novo', usuario_alt='$usuario_alt' WHERE num_os='$num_os_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar dt_prog_montagem!!!"); } 
}
*/
