...
{ $lib_baixa_tipo_busca = "WHERE baixa='E'"; $lib_baixa_tipo_busca_dados = "AND baixa='E'"; $lib_baixa_tipo_texto = "Mostrar somente o que já foi Produzido."; }
/* LIBERAR USUARIO PARA VER TUDO OU SOMENTE O Q ESTA SENDO PRODUZIDO */
?>

<td class=right> Tipo Campo
<select name="tipo_busca" OnChange="Atualizar_Dados_PCP_Altera_Antigos();">
...
$busca_valor=mysql_query("select distinct $tipo_busca from Antigos $lib_baixa_tipo_busca order by $tipo_busca");
...
<? /* BOTÃO DE BUSCAR */ ?>
<input class="botao1" name="busca" type="button" value="Buscar" Onclick="Atualizar_Dados_PCP_Altera_Antigos();">
...
<input class=botao4 type="radio" name="organizar" value="data_emissao" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Dt. Emissão'); return true;" onMouseOut="nd(); return true;"> Dt. Emissão <? } } ?></P></TH>

<? /* NUM_OS */ ?>             
<? if ( $lib_num_os == "ver" Or $lib_num_os == "alt" ) { ?>
<TH align=middle  rowspan="2"><P class=bordas>
<?	if (  $check_num_os == "" ) { ?> 
<input class=botao4 type="radio" name="organizar" value="num_os" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Núm. O.S'); return true;" onMouseOut="nd(); return true;"> N° O.S <? } } ?></P></TH>
...
<input class=botao4 type="radio" name="organizar" value="num_proposta" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Núm. Proposta'); return true;" onMouseOut="nd(); return true;"> N° Proposta <? } } ?></P></TH>
...
<input class=botao4 type="radio" name="organizar" value="nome_cliente" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Nome Cliente'); return true;" onMouseOut="nd(); return true;"> Nome Cliente <? } } ?></P></TH>
...
<TH align=middle  rowspan="2"><P class=bordas>	
<? if ( $check_oc_obra == "") { ?> 
<input class=botao4 type="radio" name="organizar" value="oc_obra" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Oc_Obra'); return true;" onMouseOut="nd(); return true;">OC / Obra <? } } ?></P></TH>
...
<TH align=middle  rowspan="2"><P class=bordas>	
<? if ( $check_mercado == "") { ?> 
<input class=botao4 type="radio" name="organizar" value="mercado" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Mercado'); return true;" onMouseOut="nd(); return true;"> Merc. <? } } ?></P></TH>
...
<input class=botao4 type="radio" name="organizar" value="representante" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Representante'); return true;" onMouseOut="nd(); return true;"> Repres. <? } } ?></P></TH>
...
<TH align=middle  rowspan="2"><P class=bordas>	
<? if ( $check_estado == "") {?> 
<input class=botao4 type="radio" name="organizar" value="estado" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Estado'); return true;" onMouseOut="nd(); return true;"> Estado <? } } ?></P></TH>
...
<input class=botao4 type="radio" name="organizar" value="data_entrega" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Data Entrega'); return true;" onMouseOut="nd(); return true;"> Dt. Entrega <? } } ?></P></TH>
...
<input class=botao4 type="radio" name="organizar" value="reprogramacao" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Reprogramação'); return true;" onMouseOut="nd(); return true;"> Reprog. <? } } ?></P></TH>
...
<TH align=middle  rowspan="2"><P class=bordas>	
<? if ( $check_baixa == "") {?> 
<input class=botao4 type="radio" name="organizar" value="baixa" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Baixa'); return true;" onMouseOut="nd(); return true;"> Baixa <? } } ?></P></TH>
...
<TH align=middle  rowspan="2"><P class=bordas>	
<? if ( $check_data_baixa == "") {?> 
<input class=botao4 type="radio" name="organizar" value="data_baixa" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Data Baixa'); return true;" onMouseOut="nd(); return true;"> Dt. da Baixa <? } } ?></P></TH>
...
<input class=botao4 type="radio" name="organizar" value="data_prog_diaria" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Data Prog. Diária'); return true;" onMouseOut="nd(); return true;"> Dt. Prog. Diária <? } } ?></P></TH>

<?/*  DATA PREVISAO  */?>
<? if ( $lib_data_previsao == "ver" Or $lib_data_previsao == "alt" ) { ?> 
<TH align=middle  rowspan="2"><P class=bordas>	
<? if ( $check_data_previsao == "") {?> 
<input class=botao4 type="radio" name="organizar" value="data_previsao" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Data Previsão'); return true;" onMouseOut="nd(); return true;"> Dt. Previsão <? } } ?></P></TH>

<? /* LOCAL VENDA */ ?>
<? if ( $lib_local_venda == "ver" Or $lib_local_venda == "alt" ) { ?>
<TH align=middle  rowspan="2"><P class=bordas>	
<? if ( $check_local_venda == "") {?> 
<input class=botao4 type="radio" name="organizar" value="local_venda" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Local Venda'); return true;" onMouseOut="nd(); return true;"> Local Venda <? } } ?></P></TH>

<? /* FORNECIMENTO MOTOR */ ?>
<? if ( $lib_fornecimento_motor == "ver" Or $lib_fornecimento_motor == "alt" ) { ?>
<TH align=middle  rowspan="2"><P class=bordas>
<?	if ( $check_fornecimento_motor == "") {?> 
<input class=botao4 type="radio" name="organizar" value="fornecimento_motor" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Forn. Motor'); return true;" onMouseOut="nd(); return true;"> Forn. Mot. <? } } ?></P></TH>

<? /* DATA MOTOR RECEBIDO */ ?>
<? if ( $lib_data_motor_recebido == "ver" Or $lib_data_motor_recebido == "alt" ) {?>
<TH align=middle  rowspan="2"><P class=bordas>
<?	if (  $check_data_motor_recebido == "") {?> 
<input class=botao4 type="radio" name="organizar" value="data_motor_recebido" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Data Motor Recebido'); return true;" onMouseOut="nd(); return true;"> Dt. Motor Recebido <? } } ?></P></TH>

<? /* DESCRICAO VENT */ ?>
<? if ( $lib_descr_vent == "ver" Or $lib_descr_vent == "alt" ) { ?>
<TH align=middle  rowspan="2"><P class=bordas>	
<? if ( $check_descr_vent == "") {?> 
<input class=botao4 type="radio" name="organizar" value="descr_vent" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Descrição Ventilador'); return true;" onMouseOut="nd(); return true;"> Descr. Vent. <? } } ?></P></TH>

<? /* QT */ ?>
<? if ( $lib_qt == "ver" Or $lib_qt == "alt" ) { ?>
<TH align=middle  rowspan="2"><P class=bordas>
<?	if ( $check_qt == "") {?> 
<input class=botao4 type="radio" name="organizar" value="qt" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar QT'); return true;" onMouseOut="nd(); return true;"> QT <? } } ?></P></TH>

<? /* MODELO */ ?>
<? if ( $lib_modelo == "ver" Or $lib_modelo == "alt" ) { ?>
<TH align=middle  rowspan="2"><P class=bordas>
<?	if ( $check_modelo == "") {?> 
<input class=botao4 type="radio" name="organizar" value="modelo" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Modelo'); return true;" onMouseOut="nd(); return true;"> Mod. <? } } ?></P></TH>

<? /* TAMANHO */ ?>
<? if ( $lib_tamanho == "ver" Or $lib_tamanho == "alt" ) { ?>
<TH align=middle  rowspan="2"><P class=bordas>
<?	if ( $check_tamanho == "") {?> 
<input class=botao4 type="radio" name="organizar" value="tamanho" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Tamanho'); return true;" onMouseOut="nd(); return true;"> Tam. <? } } ?></P></TH>

<? /* ARRANJO */ ?>
<? if ( $lib_arranjo == "ver" Or $lib_arranjo == "alt" ) { ?>
<TH align=middle  rowspan="2"><P class=bordas>
<?	if ( $check_arranjo == "") {?> 
<input class=botao4 type="radio" name="organizar" value="arranjo" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Arranjo'); return true;" onMouseOut="nd(); return true;"> Arr. <? } } ?></P></TH>

<? /* CLASSE */ ?>
<? if ( $lib_classe == "ver" Or $lib_classe == "alt" ) { ?>
<TH align=middle  rowspan="2"><P class=bordas>
<?	if ( $check_classe == "") {?> 
<input class=botao4 type="radio" name="organizar" value="classe" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Classe'); return true;" onMouseOut="nd(); return true;"> Cl. <? } } ?></P></TH>

<? /* ROTACAO */ ?>
<? if ( $lib_rotacao == "ver" Or $lib_rotacao == "alt" ) { ?>
<TH align=middle  rowspan="2"><P class=bordas>
<?	if ( $check_rotacao == "") {?> 
<input class=botao4 type="radio" name="organizar" value="rotacao" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Rotação'); return true;" onMouseOut="nd(); return true;"> Rot. <? } } ?></P></TH>

<? /* GABINETE */ ?>
<? if ( $lib_gab == "ver" Or $lib_gab == "alt" ) { ?>
<TH align=middle  rowspan="2"><P class=bordas>
<?	if ( $check_gab == "") {?>
<input class=botao4 type="radio" name="organizar" value="gab" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Gabinete'); return true;" onMouseOut="nd(); return true;"> Gab. <? } } ?></P></TH>

<? /* PINTURA */ ?>
<? if ( $lib_pintura == "ver" Or $lib_pintura == "alt" ) { ?>
<TH align=middle  rowspan="2"><P class=bordas>
<?	if ( $check_pintura == "") {?> 
<input class=botao4 type="radio" name="organizar" value="pintura" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Pintura'); return true;" onMouseOut="nd(); return true;"> Pint. <? } } ?></P></TH>

<? /* CONSTRUÇÃO */ ?>
<? if ( $lib_construcao == "ver" Or $lib_construcao == "alt" ) { ?>
<TH align=middle  rowspan="2"><P class=bordas>
<?	if ( $check_construcao == "") {?> 
<input class=botao4 type="radio" name="organizar" value="construcao" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Construção'); return true;" onMouseOut="nd(); return true;"> Const. <? } } ?></P></TH>

<? /* VALOR UNITARIO */ ?>
<? if ( $lib_valor_uni == "ver" Or $lib_valor_uni == "alt" ) { ?>
<TH align=middle  rowspan="2"><P class=bordas>
<?	if ( $check_valor_uni == "") {?> 
<input class=botao4 type="radio" name="organizar" value="valor_uni" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Valor Unitário'); return true;" onMouseOut="nd(); return true;"> Valor Un. <? } } ?></P></TH>

<? /* VALOR TOTAL O.S */ ?>
<? if ( $lib_valor_total == "ver" Or $lib_valor_total == "alt" ) { ?>
<TH align=middle  rowspan="2"><P class=bordas>
<?	if ( $check_valor_total == "") {?> 
<input class=botao4 type="radio" name="organizar" value="valor_total" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Valor Total'); return true;" onMouseOut="nd(); return true;"> Sub-Total <? } } ?></P></TH>
...
<input class=botao4 type="radio" name="organizar" value="motor_maxsig" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Motor'); return true;" onMouseOut="nd(); return true;"> Motor <? } } ?></P></TH>

<? /* POLIA MAXSIG */ ?>
<? if ( $lib_polia_maxsig == "ver" Or $lib_polia_maxsig == "alt" ) { ?>
<TH align=middle  rowspan="2"><P class=bordas>
<?	if ( $check_polia_maxsig == "") {?> 
<input class=botao4 type="radio" name="organizar" value="polia_maxsig" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Polia'); return true;" onMouseOut="nd(); return true;"> Polia <? } } ?></P></TH>

<? /* FUND MAXSIG */ ?>
<? if ( $lib_fund_maxsig == "ver" Or $lib_fund_maxsig == "alt" ) { ?>
<TH align=middle  rowspan="2"><P class=bordas>
<?	if ( $check_fund_maxsig == "") {?> 
<input class=botao4 type="radio" name="organizar" value="fund_maxsig" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Fund.'); return true;" onMouseOut="nd(); return true;"> Fund. <? } } ?></P></TH>

<? /* OUTROS MAXSIG */ ?>
<? if ( $lib_outros_maxsig == "ver" Or $lib_outros_maxsig == "alt" ) { ?>
<TH align=middle  rowspan="2"><P class=bordas>
<?	if ( $check_outros_maxsig == "") {?> 
<input class=botao4 type="radio" name="organizar" value="outros_maxsig" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar Outros'); return true;" onMouseOut="nd(); return true;"> Outros <? } } ?></P></TH>
...
<TH align=middle  rowspan="2"><P class=bordas>
<?	if ( $check_obs == "") {?> 
<input class=botao4 type="radio" name="organizar" value="obs" onClick="Atualizar_Dados_PCP_Altera_Antigos();" onMouseOver="drc('','Organizar OBS'); return true;" onMouseOut="nd(); return true;"> OBS <? } } ?></P></TH>
...
$query = "SELECT * FROM Antigos WHERE $tipo_busca<>'' AND $tipo_busca='$valor' $f_baixa_db ORDER BY '$organizar'";
