...
/* IMPRIMIR ETIQUETAS */
$lib_imprimir_etiquetas = $linha["lib_imprimir_etiquetas"]; 
...
<? if ($lib_consulta_os == "sim") { ?>
<td width=8%>
<input class="botao1" size=1 type="button" value="Imprimir Etiquetas" onClick="Abrir_imprimir_etiquetas();">
</td>
<? } ?>
...
<td width=8%>
<? if ($lib_consulta_os == "sim") { ?>
<input class="botao1" size=1 type="button" value="Cons. Campo PCP-Antigos" onClick="Abrir_PCP_Antigos();">
</td>
<? } ?>
<td width=8%>
<? if ($lib_consulta_os == "sim") { ?>
<input class="botao1" size=1 type="button" value="Cons. PCP-Antigos" onClick="Abrir_PCP_Geral_Antigos();">
</td>
<? } ?>

<td width=8%>
<? if ($lib_montagem == "ver" or $lib_montagem == "alt") { ?>
<input class="botao1" size=1 type="button" value="Painel Montagem" onClick="Abrir_PCP_Painel_Montagem();">
</td>
<? } ?>

<td class=right >Usuário  <? echo "$nome_usuario" ?><br>Hoje <? echo "$data_hoje"?></td>
</tr>
</table>
