...
<input class=botao4 type="radio" name="organizar" value="n_cons_cliente" onClick="Atualizar_Dados_PCP_Altera();" onMouseOver="drc('','Organizar Nº Cons. Cliente'); return true;" onMouseOut="nd(); return true;"> Nº Cons. Cliente <? } } ?></P></TH>
...
<TH align=middle widht="10%" colspan="8"><P class=bordas>
...
<? /* OBS */ ?>
<? if ( $lib_falta_montagem == "ver" OR $lib_falta_montagem == "alt" OR $lib_setor_ver == "sim" ) { ?>
<TH align=middle widht="8%" ><P class=bordas>
<?	if ( $check_montagem == "" ) { ?>  Falta 
<? } } ?>
</P></TH>
...
<?	if ( $check_pintura == "" ) { ?>
<span style="width:40px;word-wrap:break-word;"> 
<input class=left <?echo $class_pintura;?> <?echo $readonly_pintura;?> <?echo $disabled_pintura;?> name=pintura_novo[<?echo$x;?>] maxLength=20 size=20 value="<?echo $pintura?>" onchange="this.value = this.value.toUpperCase();">
</span>
<? } } ?>
</P></TD>
...
<?   /* Falta */  ?>
<TD align=middle><P class=bordas> 
<textarea <?echo $class_falta_montagem;?> <?echo $readonly_falta_montagem;?> <?echo $disabled_falta_montagem;?> name=falta_montagem_novo[<?echo$x;?>] rows=2 cols=25 id="textbox1" onchange="this.value = this.value.toUpperCase();"><? echo $falta_montagem; ?></textarea>
...
var arvore_pintura = new Array(<?= $palavras_pintura ?>);
