...
/*		STATUS	e DT STATUS	*/
 ...
 $falta_montagem_novo_db = $falta_montagem_novo[$i] ;  // OBS NOVO
 ...
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), status_montagem='$status_montagem_novo_db', res_montagem='$res_montagem_novo_db', obs_montagem='$obs_montagem_novo_db', dt_previsao_montagem='$dt_previsao_montagem_novo_db', falta_montagem='$falta_montagem_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar status_montagem_novo OS!!!");  
 
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), dt_producao_montagem='$dt_producao_montagem_novo_db', res_montagem='$res_montagem_novo_db', obs_montagem='$obs_montagem_novo_db', dt_previsao_montagem='$dt_previsao_montagem_novo_db', falta_montagem='$falta_montagem_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar dt_producao_montagem_novo!!!"); 
  
 $sql = "UPDATE pcp SET data_emissao_alt=NOW(), dt_exp_montagem='$dt_exp_montagem_novo_db', res_montagem='$res_montagem_novo_db', obs_montagem='$obs_montagem_novo_db', dt_previsao_montagem='$dt_previsao_montagem_novo_db', falta_montagem='$falta_montagem_novo_db', usuario_alt='$usuario_alt' WHERE id='$id_novo'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar dt_exp_montagem_novo!!!");
