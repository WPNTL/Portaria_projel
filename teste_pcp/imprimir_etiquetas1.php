...
$int_lub = $dados["int_lub"];
   ...
   $pdf->Cell(8, 6, "Rot.", 0, 0, 'C'); $pdf->Cell(13, 6, $rotacao_rpm, 1, 0, 'C'); $pdf->Cell(9, 6, "rpm", 0, 1, 'C');
   $pdf->Ln(1);
   
   $pdf->Cell(15, 6, "Vazão", 0, 0, 'R'); $pdf->Cell(20, 6, $vazao, 1, 0, 'C'); $pdf->Cell(10, 6, "m³/h", 0, 0, 'C'); 
   $pdf->Cell(13, 6, "P/ Est.", 0, 0, 'C'); $pdf->Cell(13, 6, $p_estatica_op, 1, 0, 'C'); $pdf->Cell(14, 6, "mmCA", 0, 1, 'C');
   $pdf->Ln(2);
