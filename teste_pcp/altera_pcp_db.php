...
/*	LIBERAR INSP */
if ($lib_liberar_insp == "alt"){$sql = "UPDATE pcp SET data_emissao_alt=NOW(), liberar_insp='$liberar_insp_novo' ,usuario_alt='$usuario_alt' WHERE id='$id'"; $resultado = mysql_query($sql) or die ("Não foi possível Alterar LIberar Inspeção!!!");}
