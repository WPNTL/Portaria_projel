...
/*  ----------------	BUSCAR DADOS DE LIBERAÇÃO ------------------	*/
?>
<form action="imprimir_etiquetas.php?<?echo $tipo_busca?><?echo $valor?><?echo $selecionadas?>" method="post" name="imprimir_pcp_etiquetas">
...
$query = "SELECT * FROM pcp WHERE $tipo_busca<>'' AND $tipo_busca='$valor' OR $tipo_busca='$valor2' $f_baixa_db ORDER BY '$organizar'";
...
<? } ?>	
	  ...
	  <input class="botao1" type="submit"><input type="button" value="IMPRIMIR" onclick="print('imprimir_etiquetas.php')">
</FIELDSET>
</form>
</body>
</html>